...
use App\Livewire\Rrhh\RolesMgr;
use Barryvdh\DomPDF\Facade\Pdf;
use App\Livewire\Finance\MyDtes;
use App\Livewire\HealthServices;
use App\Livewire\News\CreateNews;
use App\Livewire\News\SearchNews;
use App\Livewire\TestFileManager;
use App\Livewire\Inventory\Fusion;
use App\Livewire\Lobby\MeetingMgr;
use App\Livewire\Rem\SeccionIndex;
use App\Livewire\Rrhh\ShiftsIndex;
use App\Livewire\Rrhh\UserProfile;
use App\Livewire\Summary\TypeCrud;
use App\Livewire\Finance\IndexDtes;
use App\Livewire\Finance\UploadBhe;
use App\Livewire\Finance\UploadTgr;
use App\Models\Pharmacies\Purchase;
use App\Models\Rrhh\OvertimeRefund;
use App\Livewire\Finance\ManualDtes;
use App\Livewire\Finance\UploadDtes;
use App\Livewire\Inventory\Transfer;
use Illuminate\Support\Facades\Auth;
use App\Livewire\His\ModificationMgr;
use App\Livewire\His\NewModification;
use App\Livewire\Inventory\UpdatePma;
use App\Livewire\Parameters\Holidays;
use App\Livewire\Rrhh\PermissionsMgr;
use App\Livewire\Sign\SignatureIndex;
use Illuminate\Support\Facades\Route;
use App\Livewire\Authorities\Calendar;
use App\Livewire\Finance\Dte\Cenabast;
use App\Livewire\Inventory\AssignUser;
use App\Livewire\Profile\Subrogations;
use App\Livewire\Rem\SeccionGenerator;
use App\Livewire\Documents\DocumentMgr;
use App\Livewire\Documents\Tic\Informe;
use App\Livewire\Finance\PaymentBackup;
use App\Livewire\Profile\MailSignature;
use App\Livewire\Rrhh\ListAbsenteeisms;
use App\Livewire\Sign\RequestSignature;
use App\Livewire\TestFileUpdateManager;
use App\Models\User; /** ¿Un modelo? */
use App\Http\Controllers\FileController;
use App\Http\Controllers\HomeController;
use App\Http\Controllers\TestController;
use App\Livewire\Documents\ApprovalsMgr;
use App\Livewire\Documents\Partes\Inbox;
use App\Livewire\Drugs\EditActPrecursor;
use App\Livewire\Meetings\MeetingCreate;
use App\Livewire\Rrhh\CreateAbsenteeism;
use App\Livewire\Drugs\IndexActPrecursor;
use App\Livewire\Finance\DteConfirmation;
use App\Livewire\Finance\UploadSingleBhe;
use App\Livewire\Inventory\CheckTransfer;
use App\Livewire\Inventory\InventoryEdit;
use App\Livewire\Inventory\InventoryShow;
use App\Livewire\Requirements\Categories;
use App\Models\WebService\MercadoPublico;
use App\Livewire\Drugs\CreateActPrecursor;
use App\Livewire\Inventory\CreateTransfer;
...
use App\Livewire\Finance\AccountingCodesMgr;
use App\Livewire\Finance\Receptions\TypeMgr;
use App\Livewire\Inventory\AccountingUpdate;
use App\Livewire\Inventory\AssignedProducts;
use App\Livewire\Inventory\InventoryManager;
use App\Livewire\Inventory\InventoryPending;
use App\Livewire\Inventory\MassiveUpdatePma;
use App\Livewire\Inventory\PendingMovements;
use App\Livewire\Pharmacies\ImportReception;
use App\Livewire\Rrhh\NoAttendanceRecordMgr;
use App\Livewire\Welfare\Amipass\RequestMgr;
use App\Livewire\Welfare\Benefits\Subsidies;
use App\Livewire\Welfare\WelfareUsersImport;
use App\Http\Controllers\AssigmentController;
use App\Http\Controllers\News\NewsController;
use App\Http\Controllers\Rrhh\UserController;
use App\Livewire\Inventory\ClassificationMgr;
use App\Livewire\Inventory\RegisterInventory;
use App\Livewire\Inventory\RemovalRequestMgr;
use App\Livewire\Parameters\MaintainerPlaces;
use App\Http\Controllers\Auth\LoginController;
use App\Http\Controllers\ClaveUnicaController;
use App\Http\Controllers\WebserviceController;
use App\Livewire\Documents\DocDigital\Creados;
use App\Livewire\Finance\InstitutionalPayment;
use App\Livewire\His\ModificationRequestIndex;
use App\Livewire\Parameters\Program\BudgetMgr;
use App\Livewire\PurchasePlan\AddPurchasePlan;
use App\Livewire\Rrhh\NoAttendanceRecordIndex;
...
use App\Livewire\Indicators\PrestacionesLoader;
use App\Livewire\Rrhh\PerformanceReport\Period;
use App\Livewire\Summary\Template\ShowTemplate;
use App\Livewire\Welfare\Amipass\ReportByDates;
...
use App\Livewire\RequestForm\ReportGlobalBudget;
use App\Livewire\Welfare\Benefits\RequestsAdmin;
use App\Http\Controllers\CalendarEventController;
use App\Http\Controllers\PasswordResetController;
use App\Http\Controllers\Rem\RemPeriodController;
use App\Http\Controllers\Unspsc\FamilyController;
use App\Livewire\Finance\FixedFund\FormFixedFund;
use App\Livewire\ProfAgenda\Reports\SirsapReport;
...
use App\Livewire\Documents\Partes\NumerationInbox;
use App\Livewire\Documents\Partes\PartesAccessLog;
use App\Livewire\Finance\FixedFund\IndexFixedFund;
use App\Livewire\Finance\Receptions\EditReception;
use App\Livewire\Rrhh\Attendance\AttendanceUpload;
use App\Livewire\Welfare\Amipass\ReportByEmployee;
...
use App\Livewire\Finance\Receptions\CreateReception;
use App\Livewire\Finance\Receptions\CreateRejection;
use App\Livewire\InventoryLabel\InventoryLabelIndex;
use App\Livewire\Parameters\Parameter\ParameterEdit;
...
use App\Livewire\Parameters\Parameter\ParameterIndex;
use App\Livewire\Resources\Telephones\TelephoneIndex;
use App\Livewire\Rrhh\NoAttendanceRecordConfirmation;
...
use App\Livewire\Finance\Receptions\CreateReceptionNoOc;
use App\Livewire\Rrhh\PerformanceReport\SubmittedReport;
use App\Livewire\Welfare\Benefits\Benefits as BenefitLw;
...
use App\Livewire\ProfAgenda\Reports\ClinicalRecordReport;
...
use App\Http\Controllers\ProfAgenda\ProfessionMessageController;
...
use App\Http\Controllers\Welfare\Benefits\RequestAdminController;
...
use App\Livewire\Documents\Partes\ReportByDates as PartesReportByDates;
...
use App\Livewire\Inventory\MaintainerPlaces as InventoryMaintainerPlaces;
...
Route::prefix('replacement_staff')->as('replacement_staff.')->middleware(['auth', 'must.change.password'])->group(function () {
    ...
    Route::prefix('request')->name('request.')->group(function () {
        ...
        /* APPROVALS */
        Route::get('/{request_replacement_staff_id}/create_budget_availability_certificate_approval_view', [RequestReplacementStaffController::class, 'create_budget_availability_certificate_approval_view'])->name('create_budget_availability_certificate_approval_view');
...
Route::prefix('agreements')->as('agreements.')->middleware(['auth', 'must.change.password'])->group(function () {
    ...
    Route::get('/addendum/{addendum}/resolution/create', [AddendumController::class, 'createResolution'])->name('addendum.resolution.create');
    ...
    Route::post('/continuity/createDocument/{continuityResolution}', [ContinuityResolutionController::class, 'createDocumentResContinuity'])->name('continuity.createDocument');
...
Route::prefix('rrhh')->as('rrhh.')->group(function () {
    ...
    })->name('overtime-refunds.show')->middleware('can:view,record');
    ...
    Route::prefix('service-request')->name('service-request.')->middleware(['auth', 'must.change.password'])->group(function () {
        ...
        Route::prefix('report')->name('report.')->group(function () {
            ...
            Route::get('/bank-payment-file/{establishment_id?}/{pay_type?}/{programm_name?}', [ReportController::class, 'bankPaymentFile'])->name('bank-payment-file');
...
Route::prefix('parameters')->as('parameters.')->middleware(['auth', 'must.change.password'])->group(function () {
    ...
    Route::prefix('establishment/{establishment}/places')->as('places.')->group(function () {
        ...
        Route::get('/{place}/board', [InventoryController::class, 'board'])->name('board')->withoutMiddleware(['auth']);;
    });
...
Route::prefix('documents')->as('documents.')->middleware(['auth', 'must.change.password'])->group(function () {
    ...
    Route::prefix('docdigital')->as('docdigital.')->group(function () {
        Route::prefix('documentos')->as('documentos.')->group(function () {
            Route::get('/recibidos', Recibidos::class)->name('recibidos');
            Route::get('/creados', Creados::class)->name('creados');
            Route::get('/{documento_id}/archivo/{id}', [DocDigitalController::class,'archivo'])->name('archivo');
        });
    });
...
Route::prefix('prof_agenda')->as('prof_agenda.')->middleware(['auth'])->group(function () {
    ...
    Route::prefix('open_hour')->as('open_hour.')->middleware(['auth'])->group(function () {
        ...
        Route::get('/my-bookings', [OpenHourController::class, 'myBookings'])->name('my-bookings');
    });
    ...
    Route::prefix('profession_messages')->as('profession_messages.')->middleware(['auth'])->group(function () {
        Route::get('/', [ProfessionMessageController::class, 'index'])->name('index');
        Route::get('/edit/{professionMessage}', [ProfessionMessageController::class, 'edit'])->name('edit');
        Route::put('/update/{professionMessage}', [ProfessionMessageController::class, 'update'])->name('update');
        Route::get('/create', [ProfessionMessageController::class, 'create'])->name('create');
        Route::post('/store', [ProfessionMessageController::class, 'store'])->name('store');
        Route::delete('/{professionMessage}/destroy', [ProfessionMessageController::class, 'destroy'])->name('destroy');
    });
...
Route::prefix('finance')->as('finance.')->middleware(['auth', 'must.change.password'])->group(function () {
    ...
    Route::prefix('payments')->as('payments.')->group(function () {
        ...
        Route::get('/institutional-payment', InstitutionalPayment::class)->name('InstitutionalPayment');
    });
...
Route::prefix('purchase_plan')->as('purchase_plan.')->middleware(['auth', 'must.change.password'])->group(function () {
    ...
    Route::prefix('documents')->as('documents.')->middleware('auth')->group(function () {
        ...
        Route::get('{file}/show_attachment', [PurchasePlanController::class, 'show_attachment'])->name('show_attachment');
    });
...
Route::prefix('trainings')->as('trainings.')->middleware(['auth', 'must.change.password'])->group(function () {
    ...
    Route::get('{training}/show_summary_pdf', [TngTrainingController::class, 'show_summary_pdf'])->name('show_summary_pdf');
});
...
Route::prefix('suitability')->as('suitability.')->middleware(['auth', 'must.change.password'])->group(function () {
    ...
    Route::prefix('users')->as('users.')->group(function () {
        ...
        // Nueva ruta para editar un usuario común
        Route::get('{userExternal}/editUser', [SchoolUserController::class, 'editUser'])->name('editUser');
        Route::put('/update-user/{userExternal}', [SchoolUserController::class, 'updateUser'])->name('updateUser');

        Route::post('/convert-admin', [SchoolUserController::class, 'convertAdmin'])->name('convertAdmin');
