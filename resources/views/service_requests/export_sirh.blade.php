...
<form method="get" action="{{ route('rrhh.service-request.report.export_sirh') }}">
    <div class="form-row">
        ...
        <div class="form-group col-12 col-md-4">
            ...
            <input type="datetime-local" class="form-control" id="for_from" name="from" value="{{old('from') }}" >
        </div>
        <div class="form-group col-12 col-md-4">
            <label for="for_to">Fecha Inicio de Contrato Hasta*</label>
            <input type="datetime-local" class="form-control" id="for_to" name="to" value="{{old('to') }}">
        </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-6 col-md-4">
            <label>&nbsp;</label>
            <a type="button" class="form-control btn btn-success" target="_blank"
                href="{{
                    route('rrhh.service-request.report.export-sirh-txt',
