                                ...
                                <div class="justify" style="width: 100%;">
                                    ...
                                    @elseif($fulfillment->FulfillmentItems->where('type','Abandono de funciones')->count() > 0)
                                        @if($fulfillment->FulfillmentItems->where('type','!=','Abandono de funciones')->count() > 0)
                                            Mediante el presente certifico que <b><span class="uppercase">{{$fulfillment->serviceRequest->employee->fullName}}</span></b> ha desempeñado las actividades estipuladas en su convenio de prestación de servicios con el <b>{{$fulfillment->serviceRequest->establishment->name ?? ''}}</b> del periodo del {{$fulfillment->start_date->format('d/m/Y')}}
                                        ...
                                        @else
                                            Mediante el presente certifico que <b><span class="uppercase">{{$fulfillment->serviceRequest->employee->fullName}}</span></b> ha desempeñado las actividades estipuladas en su convenio de prestación de servicios con el <b>{{$fulfillment->serviceRequest->establishment->name ?? ''}}</b> del periodo del <b>{{$fulfillment->start_date->format('d/m/Y')}} al {{$fulfillment->FulfillmentItems->where('type','Abandono de funciones')->first()->end_date->sub(1, 'day')->format('d/m/Y')}}</b>
                                            <br>
                                            <br>
                                            Se deja constancia que el prestador de servicio Abandonó sus funciones a contar del día <b>{{$fulfillment->FulfillmentItems->where('type','Abandono de funciones')->first()->end_date->format('d/m/Y')}}</b>.
                                        @endif
                                    @elseif($fulfillment->FulfillmentItems->where('type','Término de contrato anticipado')->count() > 0)
                                        @if($fulfillment->FulfillmentItems->where('type','!=','Término de contrato anticipado')->count() > 0)
                                            ...
                                            <b>{{$fulfillment->start_date->format('d/m/Y')}} al {{$fulfillment->FulfillmentItems->where('type','Término de contrato anticipado')->first()->end_date->format('d/m/Y')}}</b>
                                            <br><br>
                                            Se deja constancia que el prestador de servicio se le realizó por parte de su jefatura directa un Término de contrato anticipado a contar del día <b>{{$fulfillment->FulfillmentItems->where('type','Término de contrato anticipado')->first()->end_date->format('d/m/Y')}}</b>
                                        @else
                                            Mediante el presente certifico que <b><span class="uppercase">{{$fulfillment->serviceRequest->employee->fullName}}</span></b> ha desempeñado las actividades estipuladas en su convenio de prestación de servicios con el <b>{{$fulfillment->serviceRequest->establishment->name ?? ''}}</b> del periodo del
                                            <b>{{$fulfillment->start_date->format('d/m/Y')}} al {{$fulfillment->FulfillmentItems->where('type','Término de contrato anticipado')->first()->end_date->sub(1, 'day')->format('d/m/Y')}}</b>
                                            <br><br>
                                            Se deja constancia que el prestador de servicio se le realizó por parte de su jefatura directa un Término de contrato anticipado a contar del día <b>{{$fulfillment->FulfillmentItems->where('type','Término de contrato anticipado')->first()->end_date->format('d/m/Y')}}</b>
                                        @endif
                                    @else
                                        ...
                                        @if($fulfillment->serviceRequest->type == 'Covid')
                                            durante el periodo de contingencia COVID
                                        @endif
                                        <b>{{$fulfillment->start_date->format('d/m/Y')}}</b> al <b>{{$fulfillment->end_date->format('d/m/Y')}}</b>, registrando las siguientes ausencias:
                                    @endif
                                </div>
                            </div>
                            <br><br>
