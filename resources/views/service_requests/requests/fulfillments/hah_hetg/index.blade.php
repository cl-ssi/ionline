            ...
            @foreach($serviceRequests as $serviceRequest)
                <tr>
                    ...
                    <td nowrap class="text-center">
                        <a href="{{ route('rrhh.service-request.fulfillment.edit_hah_hetg',[$serviceRequest]) }}" class="btn btn-sm btn-outline-secondary">
                        ...
                        @can('Service Request: fulfillments rrhh')
                            <form method="POST" action="{{ route('rrhh.service-request.show.post') }}">
                                ...
                                <button type="submit" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" title="Nueva vista de cumplimientos disponible!">
                                    <span class="fas fa-edit" aria-hidden="true"></span>
                                </button>
                            </form>
                        @endcan
