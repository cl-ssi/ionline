...
<form method="GET" class="form-horizontal" action="{{ route('rrhh.service-request.report.compliance') }}">
    <div class="form-row">
        ...
        <fieldset class="form-group col-3 col-md-2">
            <label for="for_month">Período</label>
            <select name="month" class="form-control text-capitalize" required>
                <option value="">Seleccione período</option> 
                <option value="1" {{ old('month', now()->month <= 6 ? '1' : '') == '1' ? 'selected' : '' }}>Enero - Junio</option>
                <option value="2" {{ old('month', now()->month > 6 ? '2' : '') == '2' ? 'selected' : '' }}>Julio - Diciembre</option>
            </select>
        </fieldset>
        ...
        <fieldset class="form-group col-md-3">
            <label for="for_payment_date">Estado de Pago</label>
        ...
        <fieldset class="form-group col-md-3">
            <label for="">&nbsp;</label>
            <button type="submit" class="form-control btn btn-outline-primary" title="Descargar Excel" name="excel">
...
<h3 class="mb-3">Reporte de cumplimientos</h3>
...
<table class="table table-sm table-bordered table-responsive table-stripped" id="tabla_cumplimiento">
    ...
    <tr>
        ...
        <td>{{$fulfillment->servicerequest?->employee?->runFormat() ?? ''}}</td>
