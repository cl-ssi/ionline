<div class="card">
	<div class="card-header">
		<h4>Información del periodo: {{ $serviceRequest->Fulfillments->first()->year }}-{{ $serviceRequest->Fulfillments->first()->month }} 
		<span class="small float-right"> {{ $serviceRequest->Fulfillments->first()->id }}</span> </h4>
	</div>
	<div class="card-body">
