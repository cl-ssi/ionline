...
<h3>Editar de Contratación de Servicios</h3>
  ...
  <div class="form-row">
    ...
    <fieldset class="form-group col-6 col-md-3">
		    ...
		    <input type="date" class="form-control" id="for_request_date" name="request_date" required value="{{$serviceRequest->request_date->format('Y-m-d')}}" min="{{now()->subYear()->format('Y-m-d')}}" max="{{now()->addYear()->format('Y-m-d')}}">
		</fieldset>

    <fieldset class="form-group col-6 col-md-3">
		    <label for="for_start_date">F.Inicio de Contrato</label>
		    <input type="date" class="form-control" id="for_start_date" name="start_date" required value="{{$serviceRequest->start_date->format('Y-m-d')}}" min="{{now()->subYear()->format('Y-m-d')}}" max="{{now()->addYear()->format('Y-m-d')}}">
		</fieldset>

    <fieldset class="form-group col-6 col-md-3">
		    <label for="for_end_date">F.Fin de Contrato</label>
		    <input type="date" class="form-control" id="for_end_date" name="end_date" required value="{{$serviceRequest->end_date->format('Y-m-d')}}" min="{{now()->subYear()->format('Y-m-d')}}" max="{{now()->addYear()->format('Y-m-d')}}">
		</fieldset>
	...
	<div class="form-row">
		...
		<fieldset class="form-group col-12 col-md-4">
			...
			@foreach($establishments as $key => $establishment)
				<option value="{{$establishment->id}}" @if($serviceRequest->establishment_id == $establishment->id) selected @endif>{{$establishment->official_name}}</option>
			@endforeach
			</select>
		</fieldset>
		...
		<fieldset class="form-group col-6 col-md-2">
		    ...
		    <select name="weekly_hours" class="form-control" id="for_weekly_hours" required>
                ...
                <option value="18" @if($serviceRequest->weekly_hours == 18) selected @endif>18</option>
                ...
                <option value="12" @if($serviceRequest->weekly_hours == 12) selected @endif>12</option>
                ...
                <option value="2" @if($serviceRequest->weekly_hours == 2) selected @endif>2</option>
			</select>
		</fieldset>
