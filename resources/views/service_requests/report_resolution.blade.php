<?php setlocale(LC_ALL, 'es_MX', 'es', 'ES'); ?>
<html lang="es">
    <head>
        <meta charset="utf-8">
...
<p class="justify">
    <strong>QUINTO:</strong> El presente convenio empezará a regir, a contar del {{$ServiceRequest->start_date->formatLocalized('%d de %B de %Y')}} al {{$ServiceRequest->end_date->formatLocalized('%d de %B de %Y')}}, de acuerdo al artículo 52 de la Ley 19.880, sobre Bases de Procedimientos Administrativos.
</p>
