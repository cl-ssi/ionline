...
<body>
    <div class="content">
        ...
        <p class="justify">
            <strong>NOVENO:</strong> El prestador cumplirá una jornada en sistema de turno, conforme a la necesidad del servicio para el que se le contrata y se pagaran las horas efectivamente trabajadas, siempre y cuando no exista superposición horaria con las obligaciones contractuales con este Establecimiento.
        </p>
        ...
        <p class="justify">
            <strong>DÉCIMO PRIMERO:</strong> Déjese establecido que el trabajador se regirá por el procedimiento establecido en el “Manual de Procedimientos de Denuncia, Prevención y Sanación del Maltrato, Acoso Laboral y/o Sexual y Discriminación, conforme resolución vigente en el Servicio de Salud Iquique.
        </p>
        ...
        <p class="justify">
            <strong>DECIMO SEGUNDO:</strong> El prestador (a) individualizado (a) en la presente resolución tendrá los siguientes beneficios adicionales:<br><br>
