...
<ul class="nav nav-tabs mb-3">
    <!-- solo se muestra esta opción si el usuario no tiene los roles de fraccionamiento -->
    @if(!auth()->user()->hasRole(['Fraccionamiento: Químico farmaceutico','Fraccionamiento: Técnico paramédico']))
    ...
    @if(auth()->user()->hasRole(['Fraccionamiento: Químico farmaceutico','Fraccionamiento: Técnico paramédico']))
        ...
        <li class="nav-item">
            <a class="nav-link"
                href="{{ route('pharmacies.products.fractionation.index') }}">
                <i class="fas fa-shipping-fast"></i> Fraccionamiento</a>
        </li>
        @endcan
    @else
        @canany(['Pharmacy: dispatch'])
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item"
                href="{{ route('pharmacies.patients.index') }}">
                <i class="fas fa-industry"></i> Pacientes</a>
