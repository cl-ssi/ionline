<div>
    <h3 class="mb-3">Importar días compensatorios</h3>

    <div class="form-row">
        <fieldset class="form-group col-6">
            <label>Archivo (xls) - Debe tener las siguientes columnas: Rut,dv,Nombres,Inicio,Termino,Inicial,Final,horas,dias</label>
