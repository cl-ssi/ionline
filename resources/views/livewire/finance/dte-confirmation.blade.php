<div>
            ...
            <tr>
                ...
                <td>
                    @foreach ($dte->controls as $control)
                        <a class="btn btn-sm btn-primary" href="{{ route('warehouse.control.show', $control) }}"
                            target="_blank">
                            #{{ $control->id }}
                        </a>
                    @endforeach
    ...
    @if (is_null($dte->confirmation_status))
        ...
        <p>
            En el evento de aceptar el documento tributario electrónico se solicita remitir Acta de Recepcion conforme
            al Depto. de Abastecimiento y Logística.
        </p>
    @endif
