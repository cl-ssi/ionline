<div>
    ...
    <div class="form-row">
        ...
        <fieldset class="form-group col-sm-3 mb-0">
            ...
            <input class="form-control form-control-sm @error('date') is-invalid @enderror" id="date"
                wire:model.debounce.1500ms="date" type="date">
            @error('date')
        ...
        <fieldset class="form-group col-sm-4 mb-0">
            ...
            <div class="input-group input-group-sm has-validation">
                <input type="text" id="po-search"
                    ...
                    placeholder="Ingresa el código" wire:model.debounce.1500ms="po_search">
    ...
    <div class="form-row">
        <fieldset class="form-group col-sm-2">
            ...
            <input class="form-control form-control-sm @error('po_code') is-invalid @enderror" id="po-code"
                wire:model.debounce.1500ms="po_code" type="text" readonly>
            @error('po_code')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <fieldset class="form-group col-sm-2">
            ...
            <input class="form-control form-control-sm @error('po_date') is-invalid @enderror" id="po-date"
                wire:model.debounce.1500ms="po_date" type="text" readonly>
            @error('po_date')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <fieldset class="form-group col-sm-8">
            ...
            <input class="form-control form-control-sm @error('supplier_name') is-invalid @enderror" id="supplier-name"
                wire:model.debounce.1500ms="supplier_name" type="text" readonly>
        </fieldset>
    </div>
    ...
    <div class="form-row">
        <fieldset class="form-group col-sm-2">
            ...
            <select wire:model.debounce.1500ms="document_type" id="document-type"
        ...
        <fieldset class="form-group col-sm-2">
            ...
            <input class="form-control form-control-sm @error('document_date') is-invalid @enderror" id="document-date"
                wire:model.debounce.1500ms="document_date" type="date">
            @error('document_date')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <fieldset class="form-group col-sm-2">
            ...
            <input class="form-control form-control-sm @error('document_number') is-invalid @enderror"
                id="document-number" wire:model.debounce.1500ms="document_number" type="text">
        ...
        <fieldset class="form-group col-sm-3">
            ...
            <select wire:model.debounce.1500ms="program_id" id="program-id"
        ...
        <fieldset class="form-group col-sm-3">
            ...
            <input class="form-control form-control-sm @error('note') is-invalid @enderror" id="note"
                wire:model.debounce.1500ms="note" type="text">
            @error('note')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                    ...
                    <tr>
                        <td width="250px">
                            @if ($index_selected === $index && $po_item['can_edit'])
                                <div class="form-check">
                                    <input type="radio" id="select-product-unspsc" value="select-product-unspsc"
                                        wire:model="type_product_unspsc" class="form-check-input">
                            ...
                            @if (
                                ...
                                <select wire:model="unspsc_product_code" id="rf-product-id"
                            ...
                            @elseif($index_selected === $index && $type_product_unspsc == 'search-product-unspsc')
                                ...
                                <div class="input-group mb-3">
                                    <input type="text"
                                        ...
                                        id="unspsc-code" wire:model.debounce.1500ms="search_unspsc_code"
                                        type="number">
                                    <div class="input-group-append">
                                ...
                                <div class="form-row">
                                    <fieldset class="form-group col-sm-12">
                                        ...
                                        <input
                                            ...
                                            id="quantity" wire:model.debounce.1500ms="quantity" type="number"
                                            min="0">
                        ...
                        <td>
                            @if ($index_selected === $index && $po_item['disabled_wre_product'] == false)
                                ...
                                <input class="form-control form-control-sm @error('description') is-invalid @enderror"
                                    id="description" wire:model.debounce.1500ms="description" type="text">
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <td>
                            @if ($index_selected === $index && $po_item['disabled_wre_product'] == false)
                                <div class="form-check">
                                    <input type="radio" id="new-product" value="1" wire:model="type_product"
                                        class="form-check-input">
                                    <label class="form-check-label" for="new-product">Nuevo Producto</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="select-product" wire:model="type_product"
                                ...
                                @if ($type_product == 0)
                                    ...
                                    <select wire:model="wre_product_id" id="wre-product-id"
                                ...
                                @else
                                    ...
                                    <input class="form-control form-control-sm @error('barcode') is-invalid @enderror"
                                        id="barcode" wire:model.debounce.1500ms="barcode" type="text">
                                    @error('barcode')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
