<div>
    <div class="form-row">
        <fieldset class="form-group col-3 col-md-3">
            ...
            <select name="type" class="form-control" required="" wire:model="fulfillment.type">
                <option value=""></option>
        ...
        <fieldset class="form-group col-2 col-md-2">
            ...
            <input type="date" class="form-control" required="" wire:model="fulfillment.start_date">
        </fieldset>
        <fieldset class="form-group col-2 col-md-2">
            <label for="for_end_date">Término</label>
            <input type="date" class="form-control" required="" wire:model="fulfillment.end_date">
        </fieldset>
        <fieldset class="form-group col-4 col-md-4">
            <label for="for_observation">Observación</label>
            <input type="text" class="form-control" wire:model="fulfillment.observation">
        </fieldset>
