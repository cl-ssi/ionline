    ...
    <div class="form-row">
      <fieldset class="form-group col-12 col-md-4">
        ...
        <select name="type" wire:model.blur="type" class="form-control for_type" required>
          ...
          <option value="Licencia media jornada no covid">LICENCIA MÉDICA MEDIA JORNADA - NO COVID</option>
          ...
          <!-- <option value="Permiso Parental">PERMISO PARENTAL</option> -->
          <option value="Permiso Excepcional">PERMISO EXCEPCIONAL</option>
        </select>
      </fieldset>
