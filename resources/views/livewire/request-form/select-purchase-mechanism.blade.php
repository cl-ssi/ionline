<div>
    <div class="form-row">
        <fieldset class="form-group col-sm">
            ...
            <select wire:model="selectedPurchaseMechanism" name="purchase_mechanism_id" class="form-control form-control-sm" required>
        ...
        <fieldset class="form-group col-sm">
            ...
            <select wire:model="selectedPurchaseType" name="purchase_type_id" class="form-control form-control-sm" required>
                <option value="">Seleccione...</option>
