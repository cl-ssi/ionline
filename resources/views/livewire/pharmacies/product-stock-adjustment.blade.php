<div class="form-row">  
        ...
        <fieldset class="form-group col-3">
            ...
            <select id="for_due_date" name="due_date_batch" class="form-control" required wire:model="due_date_batch" wire:change="due_date_batch_change">
                <option></option>
        ...
        <fieldset class="form-group col-2">
            ...
            <input type="text" class="form-control" id="for_count" disabled wire:model.defer="count">
        </fieldset>
