<div>
    <style>
        .etiqueta {
            ...
            width: 220px; /* Ancho fijo deseado */
            font-weight: bold;
        }
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" wire:model.defer="document_id" placeholder="id de documento" aria-label="id de documento">
        ...
        @if($document)
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    @if($document->file)
                        @if($document->updated_at->diffInDays('now') <= 14)
