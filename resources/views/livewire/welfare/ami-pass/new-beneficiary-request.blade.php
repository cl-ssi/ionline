<div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col">
                        ...
                        <select id="select1" name="select1" class="custom-select">
                            <option value="rabbit">Servicio de Salud</option>
                            <option value="duck">Hospital Alto Hospicio</option>
                        </select>
                        </div>
                    </div>
                </div>
            ...
            <p class="card-text">
                ...
                <div class="form-row">
                    <div class="form-group col-3">
                        ...
                        <input id="text5" name="text5" type="text" class="form-control" placeholder="Ejemplo: 12345678-9">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-3">
                        ...
                        <small id="emailHelp" class="form-text text-muted">De acuerdo a los respaldos existentes Ej. duración de Licencia Médica, suplencia, etc.</small>
                    </div>
            
                    <div class="form-group col-6">
                        <label for="text10">Donde cumplirá funciones (especificar)</label> 
                        <input id="text10" name="text10" type="text" class="form-control">
                        <small id="emailHelp" class="form-text text-muted">Unidad organizacional, Establecimiento o Residencia</small>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="radio1" id="radio1_0" type="radio" class="custom-control-input" value="rabbit"> 
                        <label for="radio1_0" class="custom-control-label">Diurna (44 hrs.)</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="radio1" id="radio1_1" type="radio" class="custom-control-input" value="duck"> 
                        <label for="radio1_1" class="custom-control-label">Diurna (33 hrs.)</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="radio1" id="radio1_2" type="radio" class="custom-control-input" value="fish"> 
                        <label for="radio1_2" class="custom-control-label">3° Turno</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="radio1" id="radio1_3" type="radio" class="custom-control-input" value=""> 
                        <label for="radio1_3" class="custom-control-label">4° Turno</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="radio1" id="radio1_4" type="radio" class="custom-control-input" value=""> 
                ...
                <div class="form-group">
                    ...
                    <input id="text14" name="text14" type="text" class="form-control">
                </div>
                <div class="form-group">
                    <label>Ha utilizado antes el beneficio en SSI</label> 
                    <div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="radio2" id="radio2_0" type="radio" class="custom-control-input" value="rabbit"> 
                        <label for="radio2_0" class="custom-control-label">Sí</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="radio2" id="radio2_1" type="radio" class="custom-control-input" value="duck"> 
    ...
    <div class="alert alert-info" role="alert">
        ...
        <ul>
            <li>
                Se analizaran los datos y se confirmará que se cumplan los requisitos para la correcta asignación y carga Amipass.
            </li>
            <li>
