...
<form method="POST" class="form-horizontal" action="{{ route('parameters.values.update', $value) }}">
    ...
    <div class="row">
        <fieldset class="form-group col-6 col-md-4">
            ...
            <input type="text" class="form-control" id="for_contract_type" name="contract_type" value="{{ $value->contract_type}}" required>
        </fieldset>

        <fieldset class="form-group col-6 col-md-4">
            <label for="for_guard_name">Jornada</label>
            <input type="text" class="form-control" id="for_work_type" name="work_type" value="{{ $value->work_type}}" required>
        </fieldset>
