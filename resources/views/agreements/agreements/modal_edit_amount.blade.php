                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="subtitle" id="subtitle21" value="21">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="subtitle" id="subtitle24" value="24">
                            <label class="form-check-label" for="subtitle24">24 Traspaso a Comunas</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="subtitle" id="subtitle29" value="29">
                            <label class="form-check-label" for="subtitle29">29 Infraestructura</label>
                        </div>
                    </div>
                    <div class="form-group">
