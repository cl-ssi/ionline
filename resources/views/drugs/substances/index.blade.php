...
@section('content')
    ...
    <fieldset class="form-group mb-3">
        <div class="input-group">
            <a class="btn btn-primary" href="{{ route('drugs.substances.create') }}">
                <i class="fas fa-plus"></i> Agregar nuevo
            </a>
            <input type="text" class="form-control" id="forsearch" onkeyup="filter(1)" placeholder="Buscar" name="search"
                required="">
            ...
            <tbody>
                @foreach ($substances as $substance)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('drugs.substances.edit', $substance->id) }}"
