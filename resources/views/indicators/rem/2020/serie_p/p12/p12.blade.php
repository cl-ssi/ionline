...
<?php
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P1207150","P1206010","P1206020","P1206030","P1206040","P1206050","P1206060","P1206070",
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P1207170","P1207010","P1207020","P1208020","P1208030","P1208040","P1208050","P1208060",
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col10,0)) Col10
                              ,sum(ifnull(b.Col11,0)) Col11
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P1220091","P1220092","P1220093","P1220094","P1220095","P1220096","P1220097","P1220098",
    ...
    <div class="col-sm tab table-responsive" id="C">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P1207190","P1220020","P1220030","P1207030","P1207040","P1207050","P1207060","P1207070",
    ...
    <div class="col-sm tab table-responsive" id="D">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P1207180","P1220070","P1220090","P1207090","P1207100","P1207110","P1207120","P1207130",
    ...
    <div class="col-sm tab table-responsive" id="E">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="3" class="active"><strong>SECCION E: PROGRAMA DE CANCER DE CUELLO UTERINO: POBLACIÓN CON VPH VIGENTE.</strong></td>
                </tr>
                <tr>
                    <td align='center'><strong>GRUPOS DE EDAD (en años)</strong></td>
                    <td align='center'><strong>MUJERES con Examen VPH Vigente en los ultimos 5 años</strong></td>
                    <td align='center'><strong>"TRANS MASCULINO con Examen VPH Vigente en los ultimos 5 años</strong></td>
                </tr>
            </thead>
            <tbody>
                <?php
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ,sum(ifnull(b.Col02,0)) Col02
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P1240010","P1240011","P1240012","P1240013","P1240014","P1240015","P1240016") AND c.serie = "P") a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by  a.codigo_prestacion,a.descripcion,a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "P1240010"){
                        $nombre_descripcion = "30 a 34 años";
                    }
                    if ($nombre_descripcion == "P1240011"){
                        $nombre_descripcion = "35 a 39 años";
                    }
                    if ($nombre_descripcion == "P1240012"){
                        $nombre_descripcion = "40 a 44 años";
                    }
                    if ($nombre_descripcion == "P1240013"){
                        $nombre_descripcion = "45 a 49 años";
                    }
                    if ($nombre_descripcion == "P1240014"){
                        $nombre_descripcion = "50 a 54 años";
                    }
                    if ($nombre_descripcion == "P1240015"){
                        $nombre_descripcion = "55 a 59 años";
                    }
                    if ($nombre_descripcion == "P1240016"){
                        $nombre_descripcion = "60 a 64 años";
                    }
                    ?>
                <tr>
    ...
    <div class="col-sm tab table-responsive" id="F">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="12" class="active"><strong>SECCIÓN F: PROGRAMA DE CANCER DE CUELLO UTERINO: VPH REALIZADOS E INFORMADOS SEGÚN RESULTADOS Y GRUPOS DE EDAD (Examen realizados en la red pública)</strong></td>
                </tr>
                <tr>
                    <td rowspan='3' align='center' style="text-align:center; vertical-align:middle"><strong>GRUPOS DE EDAD (en años)</strong></td>
                    <td colspan='11' align='center'><strong>VPH INFORMADOS SEGÚN RESULTADO</strong></td>
                </tr>
                <tr>
                    <td rowspan='2' style="text-align:center; vertical-align:middle"><strong>TOTAL</strong></td>
                    <td rowspan='2' style="text-align:center; vertical-align:middle"><strong>VPH (-)</strong></td>
                    
                    <td colspan='3' align='center'><strong>POSITIVOS</strong></td>
                    <td rowspan='2' style="text-align:center; vertical-align:middle"><strong>TOTAL VPH INFORMADOS EN TRANS MASCULINO</strong></td>
                </tr>
                <tr>
                    
                    <td align='center'><strong>VPH 16 (+)</strong></td>
                    <td align='center'><strong>VPH 18 (+)</strong></td>
                    <td align='center'><strong>VPH AR* (+)</strong></td>
                </tr>
            </thead>
            <tbody>
                <?php
                $query = 'SELECT a.codigo_prestacion,a.descripcion
							  ...
							  ,sum(ifnull(b.Col05,0)) Col05
                              ,sum(ifnull(b.Col06,0)) Col06
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P1240017","P1240018","P1240019","P1240020","P1240021","P1240022","P1240023","P1240024",
                                                                                                "P1240025","P1240026","P1240027") AND c.serie = "P") a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by  a.codigo_prestacion,a.descripcion,a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "P1240017"){
                        $nombre_descripcion = "30 a 34 años";
                    }
                    if ($nombre_descripcion == "P1240018"){
                        $nombre_descripcion = "35 a 39 años";
                    }
                    if ($nombre_descripcion == "P1240019"){
                        $nombre_descripcion = "40 a 44 años";
                    }
                    if ($nombre_descripcion == "P1240020"){
                        $nombre_descripcion = "45 a 49 años";
                    }
                    if ($nombre_descripcion == "P1240021"){
                        $nombre_descripcion = "50 a 54 años";
                    }
                    if ($nombre_descripcion == "P1240022"){
                        $nombre_descripcion = "55 a 59 años";
                    }
                    if ($nombre_descripcion == "P1240023"){
                        $nombre_descripcion = "60 a 64 años";
                    }
                    if ($nombre_descripcion == "P1240024"){
                        $nombre_descripcion = "65 A 69 años";
                    }
                    if ($nombre_descripcion == "P1240025"){
                        $nombre_descripcion = "70 a 74 años";
                    }
                    if ($nombre_descripcion == "P1240026"){
                        $nombre_descripcion = "75 a 79 años";
                    }
                    if ($nombre_descripcion == "P1240027"){
                        $nombre_descripcion = "80 y más años";
                    }
                    ?>
                <tr>
                ...
                <tr>
                    <td colspan="12" align='left'>(*) Agrupados Alto Riesgo</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="col-sm tab table-responsive" id="F1">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="12" class="active"><strong>SECCIÓN F.1: PROGRAMA DE CANCER DE CUELLO UTERINO: VPH REALIZADOS E INFORMADOS SEGÚN RESULTADOS Y GRUPOS DE EDAD (Examen realizados en extrasistema)</strong></td>
                </tr>
                <tr>
                    <td rowspan='3' align='center' style="text-align:center; vertical-align:middle"><strong>GRUPOS DE EDAD (en años)</strong></td>
                    <td colspan='11' align='center'><strong>VPH INFORMADOS SEGÚN RESULTADO</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
							  ...
							  ,sum(ifnull(b.Col05,0)) Col05
                              ,sum(ifnull(b.Col06,0)) Col06
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P1240028","P1240029","P1240030","P1240031","P1240032","P1240033","P1240034","P1240035",
                                                                                                "P1240036","P1240037","P1240038") AND c.serie = "P") a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by  a.codigo_prestacion,a.descripcion,a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "P1240028"){
                        $nombre_descripcion = "30 a 34 años";
                    }
                    if ($nombre_descripcion == "P1240029"){
                        $nombre_descripcion = "35 a 39 años";
                    }
                    if ($nombre_descripcion == "P1240030"){
                        $nombre_descripcion = "40 a 44 años";
                    }
                    if ($nombre_descripcion == "P1240031"){
                        $nombre_descripcion = "45 a 49 años";
                    }
                    if ($nombre_descripcion == "P1240032"){
                        $nombre_descripcion = "50 a 54 años";
                    }
                    if ($nombre_descripcion == "P1240033"){
                        $nombre_descripcion = "55 a 59 años";
                    }
                    if ($nombre_descripcion == "P1240034"){
                        $nombre_descripcion = "60 a 64 años";
                    }
                    if ($nombre_descripcion == "P1240035"){
                        $nombre_descripcion = "65 A 69 años";
                    }
                    if ($nombre_descripcion == "P1240036"){
                        $nombre_descripcion = "70 a 74 años";
                    }
                    if ($nombre_descripcion == "P1240037"){
                        $nombre_descripcion = "75 a 79 años";
                    }
                    if ($nombre_descripcion == "P1240038"){
                        $nombre_descripcion = "80 y más años";
                    }
                    ?>
                <tr>
