        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P4150100",
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col35,0)) Col35
                              ,sum(ifnull(b.Col36,0)) Col36
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P4190800","P4190801","P4190810","P4190811","P4190803","P4190804") AND c.serie = "P") a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by  a.codigo_prestacion,a.descripcion,a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col34,0)) Col34
                              ,sum(ifnull(b.Col35,0)) Col35
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P4180200","P4200100",
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
									            ,sum(ifnull(b.Col05,0)) Col05
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P4190805","P4190806","P4190950","P4200600","P4200300","P4180800","P4200700","P4190960",
                                                                                                "P4190807","P4190808",
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
                              ,sum(ifnull(b.Col05,0)) Col05
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P4190812","P4200400") AND c.serie = "P") a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by  a.codigo_prestacion,a.descripcion,a.id_prestacion
                          order by a.id_prestacion';
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
                              ,sum(ifnull(b.Col05,0)) Col05
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P4201300","P4201400","P4201500","P4201600","P4200500","P4201700") AND c.serie = "P") a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by  a.codigo_prestacion,a.descripcion,a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "P4201500"){
                        $nombre_descripcion = "SOBREPESO: IMC entre 25 y 29.9 < 65";
                    }
                    if ($nombre_descripcion == "P4201600"){
                        $nombre_descripcion = "SOBREPESO: IMC entre 28 y 31.9 < 65";
                    }
                    if ($nombre_descripcion == "P4200500"){
                        $nombre_descripcion = "OBESIDAD IMC igual o Mayor a 30KG/M2 < 65";
                    }
                    if ($nombre_descripcion == "P4201700"){
                        $nombre_descripcion = "**OBESIDAD: IMC igual o Mayor a 32KG/M2 > 65";
                    }
                    ?>
                <tr>
                    <?php
                    ...
                    ?>
                    <td align='right'><?php echo number_format($row->Col01,0,",",".")?></td>
                    <td align='right' @if($row->Col02 == 0) style="background-color:#f1f1f1" @endif><?php if($row->Col02 != 0) echo number_format($row->Col02,0,",",".")?></td>
                    <td align='right' @if($row->Col03 == 0) style="background-color:#f1f1f1" @endif><?php if($row->Col03 != 0) echo number_format($row->Col03,0,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col04,0,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col05,0,",",".")?></td>
                    <?php
                    $i++;
                ...
                <tr>
                    <td colspan="7" align='left'>NOTA (*): La vigencia de la evaluación del pie diabetico es de 12 meses.</td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col15,0)) Col15
            									...
            									,sum(ifnull(b.Col22,0)) Col22
            									,sum(ifnull(b.Col23,0)) Col23
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("P4201800","P4202000","P4202000","P4202010","P4202020","P4202030","P4202040") AND c.serie = "P") a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by  a.codigo_prestacion,a.descripcion,a.id_prestacion
                          order by a.id_prestacion';
