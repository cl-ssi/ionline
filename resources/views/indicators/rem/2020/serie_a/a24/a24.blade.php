        ...
        <table class="table table-hover table-bordered table-sm">
            <thead>
                ...
                <tr>
                    ...
                    <td align="center"><strong>Partos prematuros de 33 a 36 semanas</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("01030100","01030200","01030300","24090700")) a
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col13,0)) Col13
            									...
            									,sum(ifnull(b.Col18,0)) Col18
            									,sum(ifnull(b.Col19,0)) Col19
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("01030400","24090800","24200121","24090900","24100100")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col13,0)) Col13
            									...
            									,sum(ifnull(b.Col18,0)) Col18
            									,sum(ifnull(b.Col19,0)) Col19
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("24200200","24200201","24200202")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "24200200"){
                        $nombre_descripcion = "CAUSAL N° 1: MUJER EMBARAZADA CON RIESGO VITAL";
      							}
      							if ($nombre_descripcion == "24200201"){
                        $nombre_descripcion = "CAUSAL N° 2: INVIABILIDAD FETAL DE CARÁCTER LETAL";
      							}
      							if ($nombre_descripcion == "24200202"){
                        $nombre_descripcion = "CAUSAL N° 3: POR VIOLACION";
      							}
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ,sum(ifnull(b.Col02,0)) Col02
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("01090010","01090020")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col10,0)) Col10
                              ,sum(ifnull(b.Col11,0)) Col11
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("01060100","01060101")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="C2">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("24200110","24200120")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ,sum(ifnull(b.Col02,0)) Col02
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("01090030")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col03,0)) Col03
                              ,sum(ifnull(b.Col04,0)) Col04
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("01070000","01080000")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ,sum(ifnull(b.Col02,0)) Col02
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("24200134","24200100")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col14,0)) Col14
                              ,sum(ifnull(b.Col15,0)) Col15
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("24200130","24200131","24200132","24200133")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col02,0)) Col02
                              ,sum(ifnull(b.Col03,0)) Col03
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("24300100","24300101","24300102")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
