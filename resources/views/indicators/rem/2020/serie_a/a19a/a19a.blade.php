...
<?php
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("19120201","19120202","19120203","19120204","19120206","19120208","19120210","19170100","19120211","19120212","19120205",
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "19190107"){
                        $nombre_descripcion = "ENFERMERA /O";
      							}
                ...
                <tr>
                    ...
                    if($i==67){?>
                    <td style="text-align:center; vertical-align:middle">DESARROLLO INFANTIL INTEGRAL</td>
                    <?php
                    }
                    if($i==68){?>
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("19150960","19150970","19150980","19150990","19182040","19160100",
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ,sum(ifnull(b.Col02,0)) Col02
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("19140700","19140800","19140900","19150100","19150200","19150300","19150400","19150500","19190100")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="A4">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="37" class="active"><strong>SECCIÓN A.4: CONSEJERÍAS INDIVIDUALES  CON ENTREGA DE PRESERVATIVOS (INCLUIDAS EN SECCIÓN A.1).</strong></td>
                </tr>
                <tr>
                    <td rowspan="3" colspan="2" style="text-align:center; vertical-align:middle"><strong>ACTIVIDAD</strong></td>
                ...
                <tr>
                    ...
                    <td colspan="2" align="center"><strong>75-79</strong></td>
                    <td colspan="2" align="center"><strong>80 y mas</strong></td>
                    <td colspan="2" align="center"><strong>14 a 18</strong></td>
                </tr>
                <tr>
                    <td align="center"><strong>AMBOS SEXOS</strong></td>
                    <td align="center"><strong>HOMBRES</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col34,0)) Col34
                              ,sum(ifnull(b.Col35,0)) Col35
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("19190101","19190102","19190103")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col09,0)) Col09
                              ,sum(ifnull(b.Col10,0)) Col10
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("19140101","19170700","19140102","19140103",
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col06,0)) Col06
                              ,sum(ifnull(b.Col07,0)) Col07
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("19140501","19180100","19140502","19140503")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col06,0)) Col06
                              ,sum(ifnull(b.Col07,0)) Col07
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("19140601","19180200","19140602","19140603","19182060","19140610")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col08,0)) Col08
                              ,sum(ifnull(b.Col09,0)) Col09
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("19190104","19190105","19190106")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
