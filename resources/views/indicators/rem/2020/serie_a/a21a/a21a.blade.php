...
@include('indicators.rem.2020.serie_a.a21a.search')
...
<?php
    ...
    <div class="col-sm tab table-responsive" id="A">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="28" class="active"><strong>SECCIÓN A: INGRESOS AGUDOS SEGÚN DIAGNOSTICO.</strong></td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" align="center"><strong>TOTAL HORAS MENSUALES OCUPADAS DE QUIRÓFANOS EN TRABAJO</strong></td>
                </tr>
                <tr>
                    ...
                    <td align="center"><strong>De preparación</strong></td>
                    <td align="center"><strong>Totales</strong></td>
                    <td align="center"><strong>Cirugía Menor</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("21220100","21220200","21220700","21220600")) a
                ...
                <tr>
                    ...
                    <td align='right'><strong><?php echo number_format($totalCol25,2,",",".") ?></strong></td>
                    <td align='right'><strong><?php echo number_format($totalCol26,2,",",".") ?></strong></td>
                    <td align='right'><strong><?php echo number_format($totalCol27,2,",",".") ?></strong></td>
                </tr>
                <?php
                ...
                <tr>
                    ...
                    <td align='right'><?php echo number_format($row->Col25,2,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col26,2,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col27,2,",",".")?></td>
                    <?php
                    $i++;
                }
                ?>
