...
<?php
    ...
    <div class="col-sm tab table-responsive" id="A">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="50" class="active"><strong>SECCIÓN A: CONSULTAS MÉDICAS.</strong></td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center; vertical-align:middle"><strong>ESPECIALIDADES Y SUB-ESPECIALIDADES</strong></td>
                    <td colspan="21" align="center"><strong>CONSULTAS MÉDICAS</strong></td>
                    ...
                    <td colspan="2" rowspan="2" align="center"><strong>CONSULTA MÉDICO GENERAL</strong></td>
                </tr>
                <tr>
                    ...
                    <td rowspan="2" align="center"><strong>A BENEFICIARIOS</strong></td>
                ...
                <tr>
                    ...
                    <td align="center"><strong>CAE/CDT/CRS/HOSPITALIZACION</strong></td>
                    ...
                    <td align="center"><strong>NUEVAS</strong></td>
                    <td align="center"><strong>CONTROLES</strong></td>
                    <td align="center"><strong>Menos 15&nbsp;años</strong></td>
                    <td align="center"><strong>15&nbsp;y&nbsp;más años</strong></td>
                    <td align="center"><strong>Menos 15&nbsp;años</strong></td>
                    <td align="center"><strong>15&nbsp;y&nbsp;más años</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col49,0)) Col49
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("07020130","07020230","07020330","07020331","07020332","07024219",
                ...
                foreach($registro as $row ){
                    ...
                    $totalCol49=$totalCol49+$row->Col49;
                ...
                <tr>
                    ...
                    <td align='right'><?php echo number_format($row->Col49,0,",",".")?></td>
                    <?php
                    $i++;
                }
                ?>
                ...
                <tr>
                    ...
                    <td align='right'><strong><?php echo number_format($totalCol49,0,",",".") ?></strong></td>
                </tr>
            </tbody>
        </table>
    </div>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col13,0)) Col13
            									...
            									,sum(ifnull(b.Col17,0)) Col17
            									,sum(ifnull(b.Col18,0)) Col18
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("07024203","07024204","07024205","07024206","07024207","07024208",
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col40,0)) Col40
            									,sum(ifnull(b.Col41,0)) Col41
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("07024900","07024915","07024925","07024935","07024920","07024816",
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col42,0)) Col42
                              ,sum(ifnull(b.Col43,0)) Col43
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("07024930","07024940","070251200","070251300","070251400","07030100A",
