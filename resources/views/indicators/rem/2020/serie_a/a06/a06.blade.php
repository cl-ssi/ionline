...
<?php
    ...
    <div class="col-sm tab table-responsive" id="A1">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="44" class="active"><strong>SECCIÓN A.1: CONTROLES DE ATENCION PRIMARIA / ESPECIALIDADES.</strong></td>
                </tr>
                <tr>
                    ...
                    <td rowspan='3' align='center'><strong>Demencia</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06020201","06020208","06020202","06020602","06020206","06200400",
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col41,0)) Col41
                              ,sum(ifnull(b.Col42,0)) Col42
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06902700","06200600","06905910","06300900")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="A2">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="41" class="active"><strong>SECCIÓN A.2: CONSULTORÍAS DE SALUD MENTAL EN APS.</strong></td>
                </tr>
                <tr>
                    ...
                    <td align='center' colspan="2" style="text-align:center; vertical-align:middle"><strong>CONSULTORÍAS RECIBIDAS</strong></td>
                    ...
                    <td align='center'><strong>CONSULTORÍAS DE SALUD MENTAL INFANTO ADOLESCENTE</strong></td>
                    <td align='center'><strong>CONSULTORÍAS DE SALUD MENTAL ADULTO</strong></td>
                    <td align='center'><strong>Ambos Sexos</strong></td>
                    <td align='center'><strong>Hombres</strong></td>
                    <td align='center'><strong>Mujeres</strong></td>
                    <td align='center'><strong>Hombres</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col39,0)) Col39
                              ,sum(ifnull(b.Col40,0)) Col40
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06300100")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="A3">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="10" class="active"><strong>SECCIÓN A.3: CONSULTORÍAS DE SALUD MENTAL OTORGADA POR EL NIVEL DE ESPECIALIDAD.</strong></td>
                </tr>
                <tr>
                    <td align='center' rowspan="2" style="text-align:center; vertical-align:middle"><strong>ACTIVIDAD</strong></td>
                    <td align='center' rowspan="2" style="text-align:center; vertical-align:middle"><strong>TOTAL CONSULTORÍAS OTORGADAS</strong></td>
                    <td align='center' colspan="3"><strong>TOTAL N&ordm; DE CASOS REVISADOS</strong></td>
                    <td align='center' colspan="5"><strong>PARTICIPANTES</strong></td>
                </tr>
                    <td align='center'><strong>Ambos Sexos</strong></td>
                    <td align='center'><strong>Hombres</strong></td>
                    <td align='center'><strong>Mujeres</strong></td>
                    <td align='center'><strong>Médico Psiquiatría más un profesional</strong></td>
                    <td align='center'><strong>Médico Psiquiatría más dos Profesionales</strong></td>
                    <td align='center'><strong>Uniprofesional</strong></td>
                    <td align='center'><strong>Dos profesionales</strong></td>
                    <td align='center'><strong>tres o más profesionales</strong></td>
                </tr>
            </thead>
            <tbody>
                <?php
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col08,0)) Col08
                              ,sum(ifnull(b.Col09,0)) Col09
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06907001")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "06907001"){
                        $nombre_descripcion = "CONSULTORIAS DE SALUD MENTAL";
                    }
                    ?>
                <tr>
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06400200","06400300","06400400","06400500")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col37,0)) Col37
                              ,sum(ifnull(b.Col38,0)) Col38
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06500700","06500900")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col37,0)) Col37
                              ,sum(ifnull(b.Col38,0)) Col38
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06600200","06600300","06600400","06600500","06600600","06600700",
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col07,0)) Col07
                              ,sum(ifnull(b.Col08,0)) Col08
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06900300","06900400","06900500","06900600")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col02,0)) Col02
                              ,sum(ifnull(b.Col03,0)) Col03
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06905200","06905300","06905400","06905911","06905913","06905914",
                                                                                                "06905915")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col02,0)) Col02
                              ,sum(ifnull(b.Col03,0)) Col03
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06905500","06905600","06905700","06905800","06905900")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col12,0)) Col12
                              ,sum(ifnull(b.Col13,0)) Col13
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06905901","06905902")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="E">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="39" class="active"><strong>SECCIÓN E: PLANES DE CUIDADO INTEGRAL (PCI).</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col37,0)) Col37
                              ,sum(ifnull(b.Col38,0)) Col38
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06906100")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col03,0)) Col03
                              ,sum(ifnull(b.Col04,0)) Col04
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06906105")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="G">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="10" class="active"><strong>SECCIÓN G: EVALUACIONES PROGRAMA PLAN NACIONAL DE DEMENCIA.</strong></td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center; vertical-align:middle"><strong>ACTIVIDAD</strong></td>
                    <td colspan="3" rowspan="2" style="text-align:center; vertical-align:middle"><strong>TOTAL</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col08,0)) Col08
                              ,sum(ifnull(b.Col09,0)) Col09
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06906135","06906140","06906145")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="H">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="9" class="active"><strong>SECCIÓN H: EVALUACION PROGRAMA DE APOYO A LA SALUD MENTAL INFANTIL (PASMI).</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col07,0)) Col07
                              ,sum(ifnull(b.Col08,0)) Col08
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06906150")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="I">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="43" class="active"><strong>SECCIÓN I : SALUD MENTAL EN SITUACIONES DE EMERGENCIA O DESASTRE.</strong></td>
                </tr>
                <tr>
              			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>ACTIVIDAD</strong></td>
              			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>PROFESIONAL</strong></td>
              			<td colspan="3" rowspan="2" style="text-align:center; vertical-align:middle"><strong>TOTAL</strong></td>
              			<td colspan="34" align="center"><strong>GRUPOS DE EDAD (en a&ntilde;os)</strong></td>
              			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Beneficiarios</strong></td>
              			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Ni&ntilde;os, Ni&ntilde;as, Adolescentes y J&oacute;venes Poblaci&oacute;n SENAME</strong></td>
              			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Pueblos Ind&iacute;genas</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col40,0)) Col40
                              ,sum(ifnull(b.Col41,0)) Col41
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06907002","06907003","06907004","06907005","06907006","06907007","06907008","06907009",
                                                                                                "06907010","06907011")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                ...
                foreach($registro as $row ){
                    ...
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "06907002"){
                        $nombre_descripcion = "MÉDICO";
      							}
                    if ($nombre_descripcion == "06907003"){
                        $nombre_descripcion = "PSICÓLOGO/A";
      							}
                    if ($nombre_descripcion == "06907004"){
                        $nombre_descripcion = "ENFERMERA /O";
      							}
                    if ($nombre_descripcion == "06907005"){
                        $nombre_descripcion = "MATRONA /ÓN";
      							}
                    if ($nombre_descripcion == "06907006"){
                        $nombre_descripcion = "ASISTENTE SOCIAL";
      							}
                    if ($nombre_descripcion == "06907007"){
                        $nombre_descripcion = "OTROS PROFESIONALES";
      							}
                    if ($nombre_descripcion == "06907008"){
                        $nombre_descripcion = "TERAPEUTA OCUPACIONAL";
      							}
                    if ($nombre_descripcion == "06907009"){
                        $nombre_descripcion = "TÉCNICO PARAMÉDICO y EN SALUD MENTAL";
      							}
                    if ($nombre_descripcion == "06907010"){
                        $nombre_descripcion = "GESTOR COMUNITARIO";
      							}
                    if ($nombre_descripcion == "06907011"){
                        $nombre_descripcion = "TÉCNICO REHABILITACIÓN ALCOHOL Y DROGAS";
      							}
                    ?>
                <tr>
                    @if($i == 0)
                    <td rowspan="11" style="text-align:center; vertical-align:middle">CONSULTA DE SALUD MENTAL ASOCIADA A EMERGENCIA O DESASTRE</td>
                    @endif
                    <td align='left' nowrap><?php echo $nombre_descripcion; ?></td>
                    <td align='right'><?php echo number_format($row->Col01,0,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col02,0,",",".")?></td>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col40,0)) Col40
                              ,sum(ifnull(b.Col41,0)) Col41
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06907012","06907013")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "06907012"){
                        $nombre_descripcion = "INTERVENCIÓN PSICOSOCIAL GRUPAL";
      							}
                    if ($nombre_descripcion == "06907013"){
                        $nombre_descripcion = "PRIMERA AYUDA PSICOLÓGICA";
      							}
                    ?>
                <tr>
                    <td colspan="2" align='left' nowrap><?php echo $nombre_descripcion; ?></td>
                    <td align='right'><?php echo number_format($row->Col01,0,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col02,0,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col03,0,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col04,0,",",".")?></td>
    ...
    <div class="col-sm tab table-responsive" id="I">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="43" class="active"><strong>SECCIÓN J: CONSULTA DE SALUD MENTAL POR EL NIVEL DE ESPECIALIDAD.</strong></td>
                </tr>
                <tr>
              			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>ACTIVIDAD</strong></td>
              			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>PROFESIONAL</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col40,0)) Col40
                              ,sum(ifnull(b.Col41,0)) Col41
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("06907014","06907015","06907016")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "06907014"){
                        $nombre_descripcion = "UNIPROFESIONAL";
      							}
                    if ($nombre_descripcion == "06907015"){
                        $nombre_descripcion = "DOS PROFESIONALES";
      							}
                    if ($nombre_descripcion == "06907016"){
                        $nombre_descripcion = "MULTIPROFESIONAL";
      							}
                    ?>
                <tr>
                    @if($i == 0)
                    <td rowspan="4" style="text-align:center; vertical-align:middle">CONSULTA NUEVA SALUD MENTAL (INGRESO)</td>
                    @endif
                    <td align='left' nowrap><?php echo $nombre_descripcion; ?></td>
                    <td align='right'><?php echo number_format($row->Col01,0,",",".")?></td>
                    <td align='right'><?php echo number_format($row->Col02,0,",",".")?></td>
