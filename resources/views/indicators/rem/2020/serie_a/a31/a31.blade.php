...
<h3>REM-A31. MEDICINA COMPLEMENTARIA Y PRÁCTICAS DE BIENESTAR DE LA SALUD.</h3>
...
<?php
    ...
    <div class="col-sm tab table-responsive" id="A">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="49" class="active"><strong>SECCIÓN A: TIPOS DE MEDICINA COMPLEMENTARIA Y PRÁCTICAS DE BIENESTAR DE LA SALUD ENTREGADAS EN ATENCIÓN INDIVIDUAL.</strong></td>
                </tr>
                <tr>
                    <td colspan="2" rowspan="3" style="text-align:center; vertical-align:middle"><strong>TIPO DE MEDICINA COMPLEMENTARIA O PRÁCTICA DE BIENESTAR DE LA SALUD</strong></td>
                    ...
                    <td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Pacientes</strong></td>
                    <td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Familiares / Cuidadores de los pacientes</strong></td>
                    <td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Funcionarios</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("31000000","31000001","31000002",
    ...
    <div class="col-sm tab table-responsive" id="B">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="36" class="active"><strong>SECCIÓN B: MEDICINA COMPLEMENTARIA Y PRÁCTICAS DE BIENESTAR DE LA SALUD EN ATENCIONES INDIVIDUALES O GRUPALES, SEGÚN PROFESIONAL.</strong></td>
                </tr>
                <!-- <tr>
                ...
                <tr>
                    ...
                    <td align="center"><strong>Qi Gong</strong></td>
                    <td align="center"><strong>Fitoterapia</strong></td>
                    <td align="center"><strong>Huertos Medicinales o Alimenticio/Medicinales</strong></td>
                ...
                <tr>
              			...
              			<td rowspan="2">Acupuntura</td>
              			<td rowspan="2">Homeopat&iacute;a</td>
              			<td rowspan="2">Naturopat&iacute;a</td>
              			<td colspan="27">No reguladas</td>
            		</tr>
            		<tr>
              			<td>Apiterapia</td>
              			<td>Arte terapia</td>
              			<td>Aur&iacute;culoterapia</td>
              			<td>Biodanza</td>
              			<td>Biomagnetismo</td>
              			<td>Qi Gong</td>
              			<td>Fitoterapia</td>
              			<td>Huertos Medicinales o Alimenticio/ Medicinales</td>
              			<td>Masoterapia</td>
              			<td>Medicina Antropos&oacute;fica</td>
              			<td>Meditaci&oacute;n</td>
              			<td>Quiropraxia</td>
              			<td>Reiki</td>
              			<td>Sanaci&oacute;n Pr&aacute;nica</td>
              			<td>Sinterg&eacute;tica</td>
              			<td>Sonoterapia</td>
              			<td>Tai Chi</td>
              			<td>Terapia Floral</td>
              			<td>Terapia Neural</td>
              			<td>Yoga</td>
              			<td>Constelaciones Familiares</td>
              			<td>Circulos de escucha</td>
              			<td>Musicoterapia</td>
              			<td>Danzaterapia</td>
              			<td>Dramaterapia</td>
              			<td>Otras Individuales</td>
              			<td>Otras Grupales</td>
            		</tr>
            </thead>
            <tbody>
                <?php
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("31000012","31000013","31000014","31000015","31000016","31000017","31000018","31000019",
    ...
    <div class="col-sm tab table-responsive" id="C">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="32" class="active"><strong>SECCIÓN C: ORIGEN DE LA ATENCIÓN CON MEDICINA COMPLEMENTARIA Y PRÁCTICAS DE BIENESTAR DE LA SALUD.</strong></td>
                </tr>
                <tr>
                    <td rowspan="2" style="text-align:center; vertical-align:middle"><strong>PERFIL PROFESIONAL</strong></td>
                    <td rowspan="2" style="text-align:center; vertical-align:middle"><strong>Total</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col30,0)) Col30
                              ,sum(ifnull(b.Col31,0)) Col31
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("31000035","31000036","31000037","31000038","31000026","31000047","31000027","31000028",
    ...
    <div class="col-sm tab table-responsive" id="D">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="20" class="active"><strong>SECCIÓN D: TIPOS DE MEDICINA COMPLEMENTARIA Y PRÁCTICAS DE BIENESTAR DE LA SALUD ENTREGADAS EN ATENCION GRUPAL Y COMUNITARIA.</strong></td>
                </tr>
                <tr>
            			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>TIPO DE MEDICINA COMPLEMENTARIA O PR&Aacute;CTICA DE BIENESTAR DE LA SALUD</strong></td>
            			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Total de sesiones grupales</strong></td>
            			<td colspan="3" rowspan="2" style="text-align:center; vertical-align:middle"><strong>N&ordm; de participantes</strong></td>
            			<td colspan="8" align="center"><strong>PARTICIPANTES POR EDAD</strong></td>
            			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Pacientes</strong></td>
            			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Familiares / Cuidadores de los pacientes</strong></td>
            			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Funcionarios</strong></td>
            			<td rowspan="3" style="text-align:center; vertical-align:middle"><strong>Beneficiarios</strong></td>
            		...
            		<tr>
            			<td colspan="2" align="center"><strong>Menor de 10 a&ntilde;os</strong></td>
            			<td colspan="2" align="center"><strong>10-19 a&ntilde;os</strong></td>
            			<td colspan="2" align="center"><strong>20-64 a&ntilde;os</strong></td>
            			<td colspan="2" align="center"><strong>Mayor de 64 a&ntilde;os</strong></td>
            		</tr>
            		<tr>
            			<td align="center"><strong>Ambos Sexos</strong></td>
            			<td align="center"><strong>Hombres</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col13,0)) Col13
            									...
            									,sum(ifnull(b.Col18,0)) Col18
            									,sum(ifnull(b.Col19,0)) Col19
                          FROM (select c.* from 2020prestaciones c where c.codigo_prestacion in("31000051","31000052","31000054","31000055","31000056","31000057","31000058","31000059",
                                                                                                "31000060","31000064","31000065","31000061","31000062","31000063")) a
                          left join 2020rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "31000064"){
                        $nombre_descripcion = "Qi Gong";
      							}
                    if ($nombre_descripcion == "31000065"){
                        $nombre_descripcion = "Danzaterapia";
      							}
