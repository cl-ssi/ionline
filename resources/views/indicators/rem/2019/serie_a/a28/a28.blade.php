...
<?php
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28020500","28020550","28020560","28021621","28021622","28022100","28021631","28021632")) a
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col45,0)) Col45
            									,sum(ifnull(b.Col46,0)) Col46
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28020570","28020580","28020590","28020592","28020593")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col43,0)) Col43
            									,sum(ifnull(b.Col44,0)) Col44
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28014800","05226300","05226500","05226600","05226700","28010600","28010700","05226800",
                                                                                                "28022110","05226900","28010800","28010900","28021633","28022120","28022130","28022140",
                                                                                                "28022150","28022160","28022170","28022180","28022190","28022200","28022210","28022220",
                                                                                                "28022230","28021623")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                ...
                <tr>
                    ...
                    if($i==1){?>
                    <td rowspan='21' style="text-align:center; vertical-align:middle">CONDICIÓN FÍSICA</td>
                    <?php
                    }
                    if($i>=1 && $i<=21){?>
                      <td align='left' nowrap="nowrap"><?php echo $nombre_descripcion; ?></td>
    ...
    <div class="col-sm tab table-responsive" id="A3">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                  <td colspan="47" class="active"><strong>SECCIÓN A.3: EVALUACIÓN INICIAL.</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col45,0)) Col45
            									,sum(ifnull(b.Col46,0)) Col46
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28010100","28010200","28010300","28010400","28010500")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
									            ,sum(ifnull(b.Col05,0)) Col05
                              ,sum(ifnull(b.Col06,0)) Col06
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28011000","28011100","28011200","28011300")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
									            ,sum(ifnull(b.Col05,0)) Col05
                              ,sum(ifnull(b.Col06,0)) Col06
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28020660","28020670","28020680","28020690")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
									            ,sum(ifnull(b.Col05,0)) Col05
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28011400","28020721","28011500","28022240","28022250","28022260","28011700","28022270",
                                                                                                "28022280","28022290","28022300","28022310","28022320","28022330","28012000","28012200",
                                                                                                "28020710","28012400","28012500","28022340","28022350","28011600","28012300","28020720",
                                                                                                "28020722","28020723","28020724","28022360","28022370")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
									            ,sum(ifnull(b.Col05,0)) Col05
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28012600","28012700","28012800","28012900","28013000")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
									            ,sum(ifnull(b.Col05,0)) Col05
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28013100","28013200","28013300","28013400","28013500")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="A9">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                  <td colspan="6" class="active"><strong>SECCIÓN A.9: VISITAS DOMICILIARIAS INTEGRALES.</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
									            ,sum(ifnull(b.Col05,0)) Col05
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("26274800","28021624")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="A10">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                  <td colspan="6" class="active"><strong>SECCIÓN A.10: NÚMERO DE PERSONAS QUE INGRESAN Y NÚMERO DE SESIONES DE EDUCACIÓN GRUPAL.</strong></td>
                </tr>
                <tr>
                    <td rowspan="2" style="text-align:center; vertical-align:middle"><strong>ÁREA TEMÁTICA DE PREVENCIÓN Y TRATAMIENTO</strong></td>
                    <td rowspan="2" style="text-align:center; vertical-align:middle"><strong>TOTAL</strong></td>
                    <td colspan="3" align="center"><strong>TIPO DE ESTRATEGIA</strong></td>
                    <td rowspan="2" style="text-align:center; vertical-align:middle"><strong>Otros</strong></td>
                </tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col04,0)) Col04
									            ,sum(ifnull(b.Col05,0)) Col05
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("27300800","28013600")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            <thead>
                ...
                <tr>
                    ...
                    <td colspan="3" align="center"><strong>TIPO DE ESTRATEGIA</strong></td>
                    <td rowspan="2" style="text-align:center; vertical-align:middle"><strong>Otros</strong></td>
                    <td rowspan="2" style="text-align:center; vertical-align:middle"><strong>UAPORRINO</strong></td>
                </tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col10,0)) Col10
                              ,sum(ifnull(b.Col11,0)) Col11
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28020730","28020740","28020750")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col07,0)) Col07
                              ,sum(ifnull(b.Col08,0)) Col08
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28020760","28020770","28020780","28020790",
                                                                                                "28020800","28020810","28020820","28020830","28020840",
                                                                                                "28020850","28020860","28020870","28020880","28020890","28020900",
                                                                                                "28020910","28020920")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "28020910"){
                        $nombre_descripcion = "ORGANIZACIONES DE PSD";
                    }
                    if ($nombre_descripcion == "28020920"){
                        $nombre_descripcion = "ORGANIZACIONES PARA/POR PSD";
                    }
                    ?>
                <tr>
                    <?php
                    ...
                    if($i==15){?>
                    <td rowspan="2" style="text-align:center; vertical-align:middle">ASESORÍA A GRUPOS COMUNITARIOS</td>
                    <?php
                    }
                    ?>
                    <td align='left'><?php echo $nombre_descripcion; ?></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col43,0)) Col43
            									,sum(ifnull(b.Col44,0)) Col44
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28021620","28021625","28020940","28020950","28020960","28022380","28020970","28020980",
                                                                                                "28020990","28021000","28021110","28021120","28021130","28022390","28021140","28021150",
                                                                                                "28021160","28021170","28021180","28022400","28022410","28022420","28022430","28022440",
                                                                                                "28021190")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col43,0)) Col43
            									,sum(ifnull(b.Col44,0)) Col44
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28021200","28021210","28021220","28021626","28021627")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            <thead>
                ...
                <tr>
                  ...
                  <td rowspan="3" align="center"><strong>Interconsultas a Hospitalizados (en sala)</strong></td>
                </tr>
                <tr>
                  <td colspan="2" align="center"><strong>&lt; 12 meses</strong></td>
                  <td colspan="2" align="center"><strong>12 a 23 meses</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col42,0)) Col42
            									,sum(ifnull(b.Col43,0)) Col43
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28021230","28021240","28021250","28021260","28021270","28022450")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="B3">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28021280","28021290","28021300","28021310","28022460")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="B4">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28021320","28021330","28021340","28021350")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="B5">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28021360","28021370","28021380")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="B6">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28012100","28012110","28021390","28021400","28021420","28021430","28021440","28021450",
                                                                                                "28021460","28022470","28021480","28021490","28021500","28021510","28022480","28022490",
                                                                                                "28021540","28021550","28021570","28021580","28021590","28021600","28022500","28022510",
                                                                                                "28022520","28022530","28022540","28022550","28022560","28022570","28022580","28022590",
                                                                                                "28022600","28022610","28022620")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="C">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                  <td colspan="42" class="active"><strong>SECCION C: NÚMERO DE AYUDAS TÉCNICAS ENTREGADAS POR TIPO.</strong></td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center; vertical-align:middle"><strong>AYUDAS TÉCNICAS</strong></td>
                    <td colspan="3" rowspan="2" style="text-align:center; vertical-align:middle"><strong>TOTAL</strong></td>
                    <td colspan="38" align="center"><strong>POR EDAD (en años)</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col40,0)) Col40
            									,sum(ifnull(b.Col41,0)) Col41
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28022630")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                <tr>
                    <td align='left' colspan="42">TIPOS DE AYUDAS TÉCNICAS</td>
                </tr>
                <?php
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col40,0)) Col40
            									,sum(ifnull(b.Col41,0)) Col41
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28022640","28022650","28022660","28022670","28022680","28022690","28022700","28022710",
                                                                                                "28022720","28022730","28022740","28022750","28022760","28022770")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="C1">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                  <td colspan="42" class="active"><strong>SECCION C.1: PERSONAS CON CONDICIÓN DE SALUD QUE RECIBE  AYUDAS TÉCNICAS.</strong></td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center; vertical-align:middle"><strong>CONDICIÓN DE SALUD</strong></td>
                    <td colspan="3" rowspan="2" style="text-align:center; vertical-align:middle"><strong>TOTAL</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col40,0)) Col40
            									,sum(ifnull(b.Col41,0)) Col41
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28022780")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "28022780"){
                        $nombre_descripcion = "NÚMERO DE PERSONAS CON AYUDA TÉCNICA ENTREGADA";
                    }
                    ?>
                <tr>
                ...
                <tr>
                    <td align='left' colspan="42">CONDICIONES DE SALUD</td>
                </tr>
                <?php
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ...
                              ,sum(ifnull(b.Col38,0)) Col38
            									...
            									,sum(ifnull(b.Col40,0)) Col40
            									,sum(ifnull(b.Col41,0)) Col41
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("28022790","28022800","28022810","28022820","28022830","28022840","28022850","28022860",
                                                                                                "28022870","28022880","28022890","28022900","28022910","28022920","28022930","28022940",
                                                                                                "28022950","28022960","28022970","28022980","28022990")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
