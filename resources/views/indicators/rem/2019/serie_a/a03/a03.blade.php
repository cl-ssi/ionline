...
<?php
            ...
            <tbody>
                ...
                FROM
                  (SELECT c.*
                   ...
                   WHERE c.codigo_prestacion IN ("02021730",
                                                 "03500020",
                                                 "03500030") ) prestaciones
                LEFT JOIN 2019rems rems ON (prestaciones.id_prestacion = rems.prestacion_id_prestacion)
                AND rems.Mes IN ('.$mes.')
                ...
                $registros_a1 = DB::connection('mysql_rem')->select($query);
                ?>

                @foreach( $registros_a1 as $i => $row )
                <tr>
                    @if($i==0)
                        <td align='left' colspan="2" nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                    @endif

                    @if($i==1)
                        <td rowspan="2" style="text-align:center; vertical-align:middle">RESULTADOS</td>
    ...
    <div class="col-sm tab table-responsive" id="A2">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="17" class="active"><strong>SECCIÓN A2: RESULTADOS DE LA APLICACIÓN DE ESCALA DE EVALUACIÓN DEL DESARROLLO PSICOMOTOR.</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                FROM (
                    SELECT c.*
                	FROM 2019prestaciones c
                	WHERE c.codigo_prestacion IN (
                            "02021740", "02010320", "05225303", "02010321",
                            "02010322", "05225304", "02010420", "05225305",
                            "03500366", "03500400", "03500401", "05225306",
                            "02010421", "02010422", "03500331", "03500332",
                            "03500333", "03500334", "03500335" )
                	)	prestaciones
                	LEFT JOIN
                		2019rems rems
                ...
                $registros_a2 = DB::connection('mysql_rem')->select($query);
                ?>

                @foreach($registros_a2 as $i => $row )
                    <tr>
                    @if($i==0)
                        <td align='left' colspan="2" nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                    @endif
                    ...
                    @if($i>=1 && $i<=4)
                        @if($i==1)
                            <td rowspan="4" style="text-align:center; vertical-align:middle">PRIMERA EVALUACIÓN</td>
                            <td align='left' nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                        @else
                            <td align='left' nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                        @endif
                    ...
                    @if($i>=5 && $i<=13)
                        @if($i==5)
                            <td rowspan="9" style="text-align:center; vertical-align:middle">REEVALUACIÓN</td>
                            <td align='left' nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                        @else
                            <td align='left' nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                        @endif
                    ...
                    @if($i==14)
                        <td rowspan="2" style="text-align:center; vertical-align:middle">DERIVADOS A ESPECIALIDAD</td>
                        <td align='left' nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                    @endif
                    ...
                    @if($i>=16 && $i<=18)
                        @if($i==16)
                            <td rowspan="3" style="text-align:center; vertical-align:middle">TRASLADO DE ESTABLECIMIENTO</td>
                            <td align='left' nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                        @else
                            <td align='left' nowrap="nowrap">{{ $row->nombre_descripcion }}</td>
                        @endif
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("02021790","02021810","02021820","05225307")) a
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col06,0)) Col06
                              ,sum(ifnull(b.Col07,0)) Col07
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("02021760","03500040","03500050","03500060")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col12,0)) Col12
                              ,sum(ifnull(b.Col13,0)) Col13
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("A0200001","A0200002","03500359","03500360","A0200003")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "A0200001"){
                        ...
                        $nombre_descripcion = "LACTANCIA MATERNA / LACTANCIA ARTIFICIAL";
      							}
    ...
    <div class="col-sm tab table-responsive" id="B1">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500120","03500130","03500140","03500150")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col02,0)) Col02
                              ,sum(ifnull(b.Col03,0)) Col03
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("02021830")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                <tr>
                    <td align='left' colspan="4">* Total de aplicaciones EPSA NO DEBE ser MAYOR que el Total de Gestantes ingresadas en REM A05 Sección </td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="col-sm tab table-responsive" id="B3">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="5" class="active"><strong>SECCIÓN B.3: APLICACIÓN DE ESCALA DE EDIMBURGO A GESTANTES Y MUJERES POST PARTO.</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col02,0)) Col02
                              ,sum(ifnull(b.Col03,0)) Col03
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500160","03500170","03500200","03500210")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="C">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="8" class="active"><strong>SECCIÓN C: RESULTADOS DE LA EVALUACIÓN DEL ESTADO NUTRICIONAL DEL ADOLESCENTE CON CONTROL.</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col06,0)) Col06
                              ,sum(ifnull(b.Col07,0)) Col07
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03050400","03050500","03050600","03050700","03050710")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col09,0)) Col09
            									...
            									,sum(ifnull(b.Col14,0)) Col14
            									,sum(ifnull(b.Col15,0)) Col15
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500346","03500347","03500348","03500367","03500402","03500349",
                                                                                                 "03500290","03500300")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "03500346"){
        						...
        						if ($nombre_descripcion == "03500347"){
        							  $nombre_descripcion = "Nº DE AUDIT APLICADOS";
        						}
        						if ($nombre_descripcion == "03500348"){
                        $nombre_descripcion = "Nº DE ASSIST";
                    }
        						if ($nombre_descripcion == "03500367"){
        								$nombre_descripcion = "N° DE CRAFFT";
        						}
                    if ($nombre_descripcion == "03500402"){
        								$nombre_descripcion = "N° DE ASSIST/CRAFFT (EMP/EMPAM)";
        						}
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03051000A","03051100","03051200","03051300","03051400",
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col20,0)) Col20
            									...
            									,sum(ifnull(b.Col24,0)) Col24
            									,sum(ifnull(b.Col25,0)) Col25
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500336","03500337","03500338","03500339","03500340",
    ...
    <div class="col-sm tab table-responsive" id="D3">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="27" class="active"><strong>SECCION D.3: APLICACIÓN Y RESULTADO DE PAUTA DE EVALUACIÓN Y SALUD MENTAL.</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500368","03500369","03500370","03500371","03500372","03500373")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col09,0)) Col09
            									...
            									,sum(ifnull(b.Col12,0)) Col12
            									,sum(ifnull(b.Col13,0)) Col13
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500350","03500351","03500352","03500353","03500354","03500355")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col09,0)) Col09
            									...
            									,sum(ifnull(b.Col14,0)) Col14
            									,sum(ifnull(b.Col15,0)) Col15
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500356","03500357","03500358")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col20,0)) Col20
            									...
            									,sum(ifnull(b.Col24,0)) Col24
            									,sum(ifnull(b.Col25,0)) Col25
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500361","03500362")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="D7">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="19" class="active"><strong>D.7: APLICACIÓN Y RESULTADOS DE PAUTA DE EVALUACION CON ENFOQUE DE RIESGO ODONTOLOGICO (CERO).</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col16,0)) Col16
                              ,sum(ifnull(b.Col17,0)) Col17
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500364","03500365")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col20,0)) Col20
                              ,sum(ifnull(b.Col21,0)) Col21
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500403")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
    ...
    <div class="col-sm tab table-responsive" id="F">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="22" class="active"><strong>F: TAMIZAJE TRASTORNO ESPECTRO AUTISTA (MCHAT).</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ,sum(ifnull(b.Col02,0)) Col02
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03500404","03500405","03500406","03500407")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
