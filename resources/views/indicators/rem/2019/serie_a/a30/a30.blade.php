...
<?php
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("30000000","30000001","30000002","30000003","30000004","30000005","30000006","30000007",
    ...
    <div class="col-sm tab table-responsive" id="B">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="9" class="active"><strong>SECCIÓN B: TELECONSULTA MÉDICA EN ESTABLECIMIENTOS DE ATENCIÓN SECUNDARIA DE URGENCIA.</strong></td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center; vertical-align:middle"><strong>PROFESIONALES</strong></td>
                    <td colspan="4" align="center"><strong>TELECONSULTA MEDICA DE URGENCIA DE UEH DE HOSPITALES DE ALTA Y MEDIANA COMPLEJIDAD</strong></td>
                    <td colspan="4" align="center"><strong>CONSULTAS POR TELEMEDICINA SOLICITADAS DESDE APS O NIVEL SECUNDARIO RESUELTAS POR OTRO ESTABLECIMIENTO</strong></td>
                </tr>
                <tr>
                    <td colspan="2" align="center"><strong>MENORES DE 15 AÑOS</strong></td>
                    <td colspan="2" align="center"><strong>15 AÑOS Y MÁS</strong></td>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col07,0)) Col07
                              ,sum(ifnull(b.Col08,0)) Col08
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("30000057")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "30000057"){
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col13,0)) Col13
            									,sum(ifnull(b.Col14,0)) Col14
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("30000058","30000059","30000060","30000061","30000062","30000063","30000064","30000065","30000066",
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col15,0)) Col15
            									...
            									,sum(ifnull(b.Col18,0)) Col18
            									,sum(ifnull(b.Col19,0)) Col19
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("30000071","30000072","30000073","30000074","30000075","30000076","30000077","30000078",
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col10,0)) Col10
                              ,sum(ifnull(b.Col11,0)) Col11
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("30000082","30000083","30000084","30000085")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
