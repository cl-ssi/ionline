        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("01010101","01010103","01010201","01010203","01080001","01080002",
        ...
        <table class="table table-hover table-bordered table-sm" >
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("02010101","02010201","02010103","02010105")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by  a.codigo_prestacion,a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("03010501","03010502","03010504","03010505","03030190","03030200","01030100A",
        ...
        <div class="col-sm tab table-responsive" id="D">
            <table class="table table-hover table-bordered table-sm">
                <thead>
                    ...
                    <tr>
                         <td rowspan="2" class="centrado"><strong>LUGAR DEL CONTROL, SEGÚN EDAD</strong></td>
                ...
                <tbody>
                    ...
                    $query = 'SELECT a.codigo_prestacion,a.descripcion
                                          ...
                                          ,sum(ifnull(b.Col05,0)) Col05
                                          ,sum(ifnull(b.Col06,0)) Col06
                                      FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("01030500","01030600","01030700","01030800")) a
                                      left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                                      AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                                      group by  a.codigo_prestacion,a.descripcion, a.id_prestacion
                                      order by a.id_prestacion';
        ...
        <div class="col-sm tab table-responsive" id="E">
            <table class="table table-hover table-bordered table-sm">
                <thead>
                    ...
                    <tr>
                        <td rowspan="2" class="centrado"><strong>TIPO DE CONTROLES</strong></td>
                        <td rowspan="2" class="centrado"><strong>CURSO</strong></td>
                        <td rowspan="2" class="centrado"><strong>TOTAL*</strong></td>
                        <td rowspan="2" class="centrado"><strong>TOTAL NIÑOS Y NIÑAS</strong></td>
                        <td colspan="2" align="center"><strong>SEXO</strong></td>
                    </tr>
                    <tr>
                        <td align="center"><strong>HOMBRES</strong></td>
                ...
                <tbody>
                    ...
                    $query = 'SELECT a.codigo_prestacion,a.descripcion
                                          ...
                                          ,sum(ifnull(b.Col03,0)) Col03
                                          ,sum(ifnull(b.Col04,0)) Col04
                                FROM  (select c.* from 2019prestaciones c where c.codigo_prestacion in("01031000","01031100","01031200","01031300","01031400",
                    ...
                    <tr>
                        <?php
                        if($i==0){?>
                        <td rowspan='5' align='center' colspan='' class="centrado">CONTROLES INDIVIDUALES</td>
                        <?php
                        }
                        if($i==5){?>
                        <td rowspan='5' align='center' colspan='' class="centrado">CONTROLES GRUPALES</td>
                        <?php
                        }
                        ?>
                        <td align='left'><?php echo $nombre_descripcion; ?></td>
