        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("19180400","19180500","19180600","19180700","19182070","19191010","19191020","19180800",
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col07,0)) Col07
                              ,sum(ifnull(b.Col08,0)) Col08
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("19140612","19140613","19140615","19182100","19182110")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("19150600","19140616","19140617","19140618","19150700","19140620","19150860","19140621",
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col10,0)) Col10
                              ,sum(ifnull(b.Col11,0)) Col11
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("19180300")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
        ...
        <table class="table table-hover table-bordered table-sm">
            <thead>
                ...
                <tr>
                    ...
                    <td align="center"><strong>TOTAL</strong></td>
                    <td align="center"><strong>CASOS/INSTITUCIONES</strong></td>
                </tr>
            </thead>
            <tbody>
                <?php
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                              ,sum(ifnull(b.Col02,0)) Col02
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("19160800","19160900")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
