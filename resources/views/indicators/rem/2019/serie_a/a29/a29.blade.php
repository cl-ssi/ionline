...
<?php
    ...
    <div class="col-sm tab table-responsive" id="A">
        <table class="table table-hover table-bordered table-sm">
            <thead>
                <tr>
                    <td colspan="14" class="active"><strong>SECCIÓN A: PROGRAMA DE RESOLUTIVIDAD ATENCIÓN PRIMARIA DE SALUD.</strong></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" align="center"><strong>TOTAL INTERCONSULTAS GENERADAS EN APS PARA RESOLUCION POR ESPECIALIDAD</strong></td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                          ...
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("29000000","29000001")) a
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col12,0)) Col12
                              ,sum(ifnull(b.Col13,0)) Col13
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("29000002","29000003","29000070","29000071")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "29000070"){
                        $nombre_descripcion = "TECNÓLOGO MÉDICO POR HIPOACUSIA (UAPORRINO)";
      							}
                    if ($nombre_descripcion == "29000071"){
                        $nombre_descripcion = "TECNÓLOGO MÉDICO OTRAS CONSULTAS (UAPORRINO)";
      							}
                    ?>
                <tr>
                    <td align='left' nowrap="nowrap"><?php echo $nombre_descripcion; ?></td>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col12,0)) Col12
                              ,sum(ifnull(b.Col13,0)) Col13
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("29000004","29000005")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                <tr>
                    <td align="center"><strong>CONTROLES GLAUCOMA UAPO UAPO</strong></td>
                    <td colspan="13" class="active"></td>
                </tr>
                <?php
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col12,0)) Col12
                              ,sum(ifnull(b.Col13,0)) Col13
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("29000006")) a
                          left join 2019rems b on (a.id_prestacion=b.prestacion_id_prestacion)
                          AND (b.Mes in ('.$mes.')) AND (b.establecimiento_id_establecimiento in ('.$estab.'))
                          group by a.codigo_prestacion, a.descripcion, a.id_prestacion
                          order by a.id_prestacion';
                ...
                foreach($registro as $row ){
                    $nombre_descripcion = $row->codigo_prestacion;
                    if ($nombre_descripcion == "29000006"){
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ...
                              ,sum(ifnull(b.Col12,0)) Col12
                              ,sum(ifnull(b.Col13,0)) Col13
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("29000007","29000008","29000009","29000010","29000011","29000012","29000013","29000048",
    ...
    <div class="col-sm tab table-responsive" id="C">
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                $query = 'SELECT a.codigo_prestacion,a.descripcion
                              ,sum(ifnull(b.Col01,0)) Col01
                          FROM (select c.* from 2019prestaciones c where c.codigo_prestacion in("29000034","29000035","29000036","29000037","29000038","29000039","29000040","29000041","29000042","29000043","29000053","29000054","29000055","29000056","29000044",
                ...
                foreach($registro as $row ){
                    ...
                    if ($nombre_descripcion == "29000044"){
                ...
                <tr>
                    <?php
                    if($i==0){?>
                    <td rowspan="15" style="text-align:center; vertical-align:middle">OFTALMOLOGÍA</td>
                    <?php
                    }
                    if($i==15){?>
