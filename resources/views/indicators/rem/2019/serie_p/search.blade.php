...
<div class="form-group">
    <form method="POST" action="{{ route('indicators.rems.year.serie.nserie.index', [$year, $serie, $nserie]) }}">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
              <select class="form-control selectpicker" name="periodo[]"  title="Seleccione..." data-actions-box="true" id="periodo">
                  <optgroup label="2019">
                      <option value="1" @if (in_array(1, $periodo) && $periodo!=null) selected="selected" @endif disabled>Enero</option>
                      <option value="2" @if (in_array(2, $periodo) && $periodo!=null) selected="selected" @endif disabled>Febrero</option>
                      <option value="3" @if (in_array(3, $periodo) && $periodo!=null) selected="selected" @endif disabled>Marzo</option>
                      <option value="4" @if (in_array(4, $periodo) && $periodo!=null) selected="selected" @endif disabled>Abril</option>
                      <option value="5" @if (in_array(5, $periodo) && $periodo!=null) selected="selected" @endif disabled>Mayo</option>
                      <option value="6" @if (in_array(6, $periodo) && $periodo!=null) selected="selected" @endif>Junio</option>
                      <option value="7" @if (in_array(7, $periodo) && $periodo!=null) selected="selected" @endif disabled>Julio</option>
                      <option value="8" @if (in_array(8, $periodo) && $periodo!=null) selected="selected" @endif disabled>Agosto</option>
                      <option value="9" @if (in_array(9, $periodo) && $periodo!=null) selected="selected" @endif disabled>Septiembre</option>
                      <option value="10" @if (in_array(10, $periodo) && $periodo!=null) selected="selected" @endif disabled>Octubre</option>
                      <option value="11" @if (in_array(11, $periodo) && $periodo!=null) selected="selected" @endif disabled>Noviembre</option>
