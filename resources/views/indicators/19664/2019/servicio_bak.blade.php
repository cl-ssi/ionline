...
<!-- Tab panes -->
    @foreach($data1 as $nombre_comuna => $comuna)
            ...
            <table class="table table-sm table-bordered small">
                ...
                <tbody>
                    <tr class="text-center">
                        <!--<td rowspan="2">{{ $label1['meta'] }}</td>-->
                        <td class="text-left">{{ $label1['numerador'] }}</td>
                        <td rowspan="2" class="align-middle">{{ $comuna['meta'] }}</td>
                        <td rowspan="2" class="align-middle">{{ number_format($comuna['cumplimiento'], 2, ',', '.') }}%</td>
                        <td class="text-rigth">{{ number_format($comuna['numerador'], 0, ',', '.') }}</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td class="text-rigth">{{ number_format($comuna['numerador_6'], 0, ',', '.') }}</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr class="text-center">
                        ...
                        <td class="text-rigth">{{ number_format($comuna['denominador'],0,',','.') }}</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td class="text-rigth">{{ number_format($comuna['denominador_6'], 0, ',', '.') }}</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
            ...
            <table class="table table-sm table-bordered small">
                ...
                <tbody>
                    <tr class="text-center">
                        ...
                        <td class="text-left">{{ $label2['numerador'] }}</td>
                        <td rowspan="2" class="align-middle">{{ $comuna['meta'] }}</td>
                        <td rowspan="2" class="align-middle">{{ number_format($comuna['cumplimiento'], 2, ',', '.') }}%</td>
    ...
    @foreach($data3 as $nombre_comuna => $comuna)
            ...
            <table class="table table-sm table-bordered small">
                ...
                <tbody>
                    <tr class="text-center">
                        <!--<td rowspan="2">{{ $label2['meta'] }}</td>-->
                        <td class="text-left">{{ $label3['numerador'] }}</td>
                        <td rowspan="2" class="align-middle">{{ $comuna['meta'] }}</td>
                        <td rowspan="2" class="align-middle">{{ number_format($comuna['cumplimiento'], 2, ',', '.') }}%</td>
                        <td class="text-right">{{ number_format($comuna['numerador'], 0, ',', '.') }}</td>
                        <td></td>
