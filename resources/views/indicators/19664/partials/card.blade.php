<div class="card">
    ...
    <ul class="list-group list-group-flush">
        <li class="list-group-item"><a href="{{ route('indicators.health_goals.list', [19664, 2024]) }}">2024 <span class="badge badge-warning">En Validación</span></a></li>
        <li class="list-group-item"><a href="{{ route('indicators.health_goals.list', [19664, 2023]) }}">2023 <span class="badge badge-warning">En Validación</span></a></li>
        ...
        <li class="list-group-item">
            <a href="{{ route('indicators.19664.index') }}">Años anteriores</a>
        </li>
