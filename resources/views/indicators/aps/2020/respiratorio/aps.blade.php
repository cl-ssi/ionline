                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @endif
                                          ...
                                          @else
                                            <td class="text-right">{{ number_format($establecimiento['numerador'], 0, ',', '.') }}</td>
                                            <td class="text-center" colspan="12">{{ number_format($establecimiento['numerador'], 0, ',', '.') }}</td>
                                          @endif
                                    </tr>
                                    <tr>
                                        ...
                                        @else
                                            <td class="text-right">{{ number_format($establecimiento['denominador'], 0, ',', '.') }}</td>
                                            <td class="text-center" colspan="12">{{ number_format($establecimiento['denominador'], 0, ',', '.') }}</td>
                                        @endif
                                    </tr>
                                </tbody>
                            </table>
