...
<div class="row">
    ...
    <div class="col mb-3">
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-muted"><a href="{{ route('indicators.rem.index', [2023, 'BM']) }}">2023 <span class="badge badge-pill badge-warning">En Desarrollo</span></a></li>
...
<div class="row">
    ...
    <div class="col">
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-muted"><a href="{{ route('indicators.rem.index', [2023, 'P']) }}">2023 <span class="badge badge-pill badge-warning">En Desarrollo</span></a></li>
