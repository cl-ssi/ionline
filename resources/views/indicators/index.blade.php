...
<div class="row">
    <div class="col mb-3">
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-muted"><a href="{{ route('indicators.rem.index', [2023, 'A']) }}">2023</a> <span class="badge badge-pill badge-warning">En Desarrollo</span></li>
    ...
    <div class="col mb-3">
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-muted">{{--<a href="{{ route('indicators.rem.index', [2023, 'BM']) }}">2023</a>--}}2023 <span class="badge badge-pill badge-secondary">Próximamente</span></li>
    ...
    <div class="col mb-3">
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-muted">{{--<a href="{{ route('indicators.rem.index', [2022, 'BS']) }}">2023</a>--}} 2023 <span class="badge badge-pill badge-secondary">Próximamente</span></li>
...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-muted">{{--<a href="{{ route('indicators.rem.index', [2023, 'D']) }}">2023</a>--}}2023 <span class="badge badge-pill badge-secondary">Próximamente</span></li>
    ...
    <div class="col">
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-muted">{{--<a href="{{-- route('indicators.rem.index', [2023, 'P']) }}">2023</a>--}}2023</li>
