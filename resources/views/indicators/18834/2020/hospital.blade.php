...
<table class="table table-sm table-bordered small">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right">{{ number_format($data15_hosp['denominador'], 0, ',', '.') }}</td>

            <td class="text-center" colspan="12">{{ number_format($data15_hosp['denominador'], 0, ',', '.') }}</td>
        </tr>
    </tbody>
</table>
...
<table class="table table-sm table-bordered small">
    ...
    <tbody>
        ...
        <tr>
            ...
            @foreach($data18_hosp['denominadores'] as $denominador)
                <td class="text-right">{{ number_format($denominador, 0, ',', '.') }}</td>
            @endforeach
        </tr>
    </tbody>
        ...
        <tr>
            ...
            <td rowspan="2" class="align-middle text-center">
                <span class="{{ ($data19_hosp['cumplimiento'] >= preg_replace("/[^0-9]/", '', $data19_hosp['meta'])) ? 'text-success':'text-danger' }}">
                    {{ number_format($data19_hosp['cumplimiento'], 2, ',', '.') }}%
                </span>
                <small><br>Aporte: @numero($data19_hosp['aporte'])%</small>
            </td>
            <td class="text-right">{{ number_format($data19_hosp['numerador_acumulado'], 0, ',', '.') }}</td>
            @foreach($data19_hosp['numeradores'] as $numerador)
            <td class="text-right">{{ number_format($numerador, 0, ',', '.') }}</td>
            @endforeach
        </tr>
        <tr>
            ...
            <td class="text-right">{{ number_format($data19_hosp['denominador_acumulado'], 0, ',', '.') }}</td>
            @foreach($data19_hosp['denominadores'] as $denominador)
            <td class="text-right">{{ number_format($denominador, 0, ',', '.') }}</td>
            @endforeach
        </tr>
    </tbody>
...
<table class="table table-sm table-bordered small">
    ...
    <tbody>
        <tr>
            ...
            <td rowspan="2" class="align-middle text-center">
                <span class="{{ ($data14_hosp['cumplimiento'] >= $data14_hosp['meta']) ? 'text-success':'text-danger' }}">
                    {{ number_format($data14_hosp['cumplimiento'], 2, ',', '.') }}%
                </span>
                <small><br>Aporte: @numero($data14_hosp['aporte'])%</small>
            </td>
            <td class="text-center">{{ $data14_hosp['numerador_acumulado'] }}</td>
            @foreach($data14_hosp['numeradores'] as $numerador)
            <td class="text-right">{{ number_format($numerador, 0, ',', '.') }}</td>
            @endforeach
        </tr>
        <tr>
            ...
            <td class="text-center">{{ $data14_hosp['denominador_acumulado'] }}</td>
            @foreach($data14_hosp['denominadores'] as $denominador)
            <td class="text-right">{{ number_format($denominador, 0, ',', '.') }}</td>
            @endforeach
        </tr>
    </tbody>
