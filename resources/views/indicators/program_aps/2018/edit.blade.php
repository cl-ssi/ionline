...
<h3 class="mb-3">Editar Valor en Programación 2018</h3>


<form method="POST" class="form-horizontal" action="{{ route('indicators.program_aps.2018.update', $programApsValue->id) }}">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        ...
        <fieldset class="form-group col">
            ...
            value="{{ $programApsValue->actividadesProgramadas }}" placeholder="(opcional)" name="actividadesProgramadas" >
        </fieldset>
