...
<h3 class="mb-3">Editar Valor en Programación 2019</h3>


<form method="POST" class="form-horizontal" action="{{ route('indicators.program_aps.2019.update', $programApsValue->id) }}">
    @csrf
    @method('PUT')
    ...
    <a class="btn btn-outline-secondary ml-3" href="{{ route('indicators.program_aps.2019.index') }}">Cancelar</a>
