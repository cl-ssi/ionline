                ...
                <tbody>
                    <tr class="text-center">
                        ...
                        <td rowspan="2" class="align-middle">
                            @if( $nombre_comuna =='COLCHANE' )
                                {{ number_format($comuna['numerador'], 0, ',', '.') }} paps vigentes
                            @else
                    ...
                    <table class="table table-sm table-bordered small">
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td rowspan="2" class="align-middle">
                                    @if( $nombre_comuna =='COLCHANE' )
                                        {{ number_format($establecimiento['numerador'], 0, ',', '.') }} paps vigentes
                                    @else
                            ...
                            <tr class="text-center">
                                ...
                                <td colspan="12" class="text-right">{{ number_format($establecimiento['denominador'], 0, ',', '.') }}</td>
                            </tr>
                        </tbody>
