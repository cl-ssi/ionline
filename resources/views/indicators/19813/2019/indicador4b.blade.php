            ...
            <table class="table table-sm table-bordered small">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-right">{{ number_format($comuna['denominador_12'], 0, ',', '.') }}</td>
                    </tr>
                </tbody>
            </table>
            ...
            @foreach($comuna as $nombre_establecimiento => $establecimiento)
                @if($nombre_establecimiento != 'numerador' AND
                    ...
                    <table class="table table-sm table-bordered small">
                        ...
                        <tbody>
                            <tr class="text-center">
                                <td align="left">{{ $label['numerador'] }}</td>
                            ...
                            <tr class="text-center">
                                <td align="left">{{ $label['denominador'] }}</td>
...
<script>
    ...
    var arrayJS=<?php echo json_encode($data4b2019);?>;
    /* ALTO HOSPICIO */
