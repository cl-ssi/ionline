...
<form method="post" action="{{ route('indicators.comges.action.update', [$comges->year, $comges, isset($corte) ? $corte->number : $section, $indicator, $action]) }}">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-1 months">
            ...
            <input type="number" class="form-control" id="numerator_month" name="numerator_month[]" value="{{$action->getValueByFactorAndMonth('numerador', $i)}}">
        </div>
        @endfor
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-1 months">
            <label for="month">{{$months[$i]}}</label>
            <input type="number" class="form-control" id="denominator_month" name="denominator_month[]" value="{{$action->getValueByFactorAndMonth('denominador', $i)}}">
        </div>
        @endfor
        <div class="form-group col-md-3 source" style="display: none">
