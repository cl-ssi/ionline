...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Nueva acción</li>
    </ol>
</nav>

<h3 class="mb-3">Crear nueva acción para indicador N° {{$indicator->number}} en {{$title2}}.</h3>
@if ($errors->any())
...
<form method="post" action="{{ route('indicators.comges.action.store', [$comges->year, $comges, isset($corte) ? $corte->number : $section, $indicator]) }}">
    ...
    <div class="form-row">
        <div class="form-group col-md-10">
            ...
            <input type="text" class="form-control" id="verification_means" name="verification_means" required>
        </div>
        <div class="form-group col-md-2">
            <label for="target_type">Tipo de meta aplicada</label>
            <select class="form-control" id="target_type" name="target_type">
                <option value=""></option>
                <option value="de mantención">De mantención</option>
                <option value="de disminución de la brecha">De disminución de la brecha</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-1">
            <input type="number" class="form-control" id="left_result_value" name="left_result_value[]">
        </div>
        <div class="form-group col-md-1">
        ...
        <div class="form-group col-md-1">
            <input type="number" class="form-control" id="right_result_value" name="right_result_value[]">
        </div>
        <div class="form-group col-md-1">
            <input type="text" readonly class="form-control-plaintext text-center" id="staticEmail" value="=>">
        </div>
        <div class="form-group col-md-3">
            <input type="number" class="form-control" id="compliance_value" name="compliance_value[]">
        </div>
    </div>
    @endfor
