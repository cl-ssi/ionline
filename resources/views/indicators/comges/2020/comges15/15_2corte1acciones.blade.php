    ...
    <tbody>
        <tr class="text-center">
            <td class="text-justify">
                <ol>
                    <li>{!! $data15_2[1]['accion'] !!}</li>
                </ol>
            </td>
            <td class="text-justify">
                <ol type="i" start="9">
                    <li>{!! $data15_2[1]['verificacion'] !!}</li>
                </ol>
            </td>
            <td class="align-middle text-center" rowspan="0">
            {{ $data15_2['ponderacion']  }}<br>
            {{$data15_2[1]['anual'] }}% de la evaluación anual
            </td>
        </tr>
        <tr class="text-center">
            <td class="text-justify">
                <ol start="2">
                    <li>{!! $data15_2[2]['accion'] !!}</li>
                </ol>
            </td>
            <td class="text-justify">
                <ol type="i" start="1">
                    <li>{!! $data15_2[2]['verificacion'] !!}</li>
                </ol>
            </td>            
        </tr>
    </tbody>
