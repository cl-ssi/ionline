    ...
    <tbody>
        <tr class="text-center">
            <td class="text-justify">
                <ol>
                    <li>{!! $data10_4[1]['accion'] !!}</li>
                </ol>
            </td>
            <td class="text-justify">
                <ol type="i" start="{!! $data10_4[1]['iverificacion'] !!}">
                    <li>{!! $data10_4[1]['verificacion'] !!}</li>
                </ol>
            </td>
            <td class="align-middle text-center" rowspan="0">
            {{ $data10_4['ponderacion']  }}<br>
            {{$data10_4[1]['anual'] }}% de la evaluación anual
            </td>
        </tr>
    </tbody>
</table>