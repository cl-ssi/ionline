...
@for ($i = 1; $i <= 1; $i++)
        <tr class="text-center">
            <td class="text-justify">
                <ol start="{{$i}}">
                    <li>{!! $data11_2[$i]['accion'] !!}</li>
                </ol>
            </td>
            <td class="text-justify">
                <ol type="i" start="{!! $data11_2[$i]['iverificacion'] !!}">
                    <li>{!! $data11_2[$i]['verificacion'] !!}</li>
                </ol>
            </td>
            @if ($i === 1)
            <td class="align-middle text-center" rowspan="0">
            {{ $data11_2['ponderacion']  }}<br>
            {{$data11_2[$i]['anual'] }}% de la evaluación anual
            </td>
            @endif
