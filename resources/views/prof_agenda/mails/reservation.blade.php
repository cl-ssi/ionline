...
@section('content')
    ...
    <div style="text-align: justify;">
        ...
        <p> La reserva se encuentra realizada para <b>{{$openHour->start_date->format('Y-m-d')}}</b> a las <b>{{$openHour->start_date->format('H:s')}}</b>. Se solicita llegar puntual a su hora.</p>
