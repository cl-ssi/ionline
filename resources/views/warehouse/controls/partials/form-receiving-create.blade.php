...
<div class="form-row">
    <fieldset class="form-group col-md-3">
        ...
        <select
            class="form-control custom-select-sm @error('origin_id') is-invalid @enderror"
    ...
    <fieldset class="form-group col-md-3">
        ...
        <select
            class="form-control custom-select-sm @error('program_id') is-invalid @enderror"
...
<div class="form-row">
    ...
    <fieldset class="form-group col-md-4">
        ...
        <input
            class="form-control @error('technical_signer_id') is-invalid @enderror"
            type="hidden"
        >
