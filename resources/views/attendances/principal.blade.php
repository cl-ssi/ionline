...
<body>
    {{-- <div class="card my-3 col-6 mx-auto">
        <div class="card-header bg-primary text-white">
            Ingrese su rut para confirmar su asistencia
        </div>
        <div class="card-body">
            <form action="{{ route('attendances.login') }}" method="post">
                @csrf
                <label for="rut" class="form-check-label">RUT (con puntos y con guion)</label>
                <input class="form-text" type="text" name="rut" id="rut" />
