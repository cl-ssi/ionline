...
<h5><i class="fas fa-file"></i> Editar Formulario de Reemplazos</h5>
...
<form method="POST" class="form-horizontal" action="{{ route('replacement_staff.request.update', $requestReplacementStaff) }}" enctype="multipart/form-data"/>
    ...
    <div class="form-row">
        <fieldset class="form-group col-12 col-sm-6">
            ...
            <input type="text" class="form-control" name="creator_name" id="for_creator_name" value="{{ $requestReplacementStaff->user->tinyName }}" disabled>
        </fieldset>
