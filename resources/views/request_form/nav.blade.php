<ul class="nav nav-tabs mb-3 d-print-none">
    <li class="nav-item active">
        <a class="nav-link {{ active('request_forms.create') }}"
            href="{{ route('request_forms.create') }}">
            <i class="fas fa-pencil-alt"></i> Nuevo
        </a>
    </li>
    <li class="nav-item active">
        <a class="nav-link {{ active('request_forms.index') }}"
            href="{{ route('request_forms.index') }}">
            <i class="fas fa-inbox"></i> Mis Formularios
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ active('request_forms.my_request_inbox') }}"
    ...
    <li class="nav-item">
        <a class="nav-link {{ active('request_forms.authorize_inbox') }}"
    ...
    <li class="nav-item">
        <a class="nav-link {{ active('request_forms.director_inbox') }}"
    ...
    <li class="nav-item">
        <a class="nav-link {{ active('request_forms.finance_inbox') }}"
