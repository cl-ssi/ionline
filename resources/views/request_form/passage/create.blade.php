           ...
           <div class="row justify-content-md-center"><!-- FILA 1 -->
             <div class="my-2 col-3">
              ...
              <div class="my-2 col-3">
                  ...
                  <input class="form-control form-control-sm" type="text" id="nombres" name="nombres" value="{{auth()->user()->name}}" readonly>
              </div>
              <div class="my-2 col-3">
                  <label for="forApellido_p" class="form-label">Apellido Paterno:</label>
                  <input class="form-control form-control-sm" type="text" id="apellido_p" name="apellido_p" value="{{auth()->user()->fathers_family}}" readonly>
              </div>
              <div class="my-2 col-3">
                  <label for="forApellido_m" class="form-label">Apellido Materno:</label>
                  <input class="form-control form-control-sm" type="text" id="apellido_m" name="apellido_m" value="{{auth()->user()->mothers_family}}" readonly>
              </div>
            </div><!-- FILA 1 -->
            ...
            <div class="row justify-content-md-center"><!-- FILA 2 -->
              <div class="my-3 col-3">
                  ...
                  <input class="form-control form-control-sm" type="text" id="correo" name="correo" value="{{auth()->user()->email}}" readonly>
              </div>
               <div class="my-3 col-3">
               ...
               <div class="my-3 col-3">
                   ...
                   <input class="form-control form-control-sm" type="text" id="cargo" name="cargo" value="{{auth()->user()->position}}" readonly>
               </div>
               <div class="my-3 col-3">
                   <label for="forUnidad">Unidad:</label>
                   <input class="form-control form-control-sm" type="text" id="unidad" name="unidad" value="{{auth()->user()->organizationalUnit->name}}" readonly>
               </div>
             </div><!-- FILA 2 -->
          </div><!-- CARD BODY -->
      </div><!-- CARD -->
