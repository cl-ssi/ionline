    ...
    $('#formType').change(
        function() {
            ...
            if ("10" === this.value) {
                ...
                $("#forFor").removeAttr("required");
                $("#collapse").hide();
                var contenido = '<h2 style="text-align: center; text-decoration: underline;">ACTA DE REUNI&Oacute;N</h2><p><strong>Datos de la reuni&oacute;n:</strong></p><table style="border-collapse: collapse; width: 100%;" border="1" cellpadding="5"><tbody><tr style="height: 25px;"><td><strong>Fecha:</strong></td><td style="width: 15%; text-align: center;">&nbsp;</td><td style="width: 15%; text-align: center;"><strong>Hora Inicio:&nbsp;</strong></td><td style="width: 15%; text-align: center;">&nbsp;</td><td style="width: 15%; text-align: center;"><strong>Hora t&eacute;rmino:</strong></td><td style="width: 15%; text-align: center;">&nbsp;</td></tr><tr style="height: 25px;"><td><strong>Tipo</strong>:</td><td colspan="5">&nbsp;[&nbsp; ] Ordinaria - [&nbsp; ] Lobby con instituci&oacute;n :&nbsp;&nbsp;</td></tr><tr style="height: 25px;"><td><strong>Mecanismo:</strong></td><td colspan="5">&nbsp;[&nbsp; ] Presencial&nbsp; - [&nbsp; ] Video Conferencia&nbsp; - [&nbsp; ] Otro:</td></tr></tbody></table><p><strong>Temas tratados:</strong></p><table style="width: 100%; border-collapse: collapse;" border="1"><tbody><tr><td><ol><li>&nbsp;</li></ol></td></tr></tbody></table><p><strong>Asistentes y expositores</strong></p><table style="width: 100%; border-collapse: collapse;" border="1" cellpadding="5"><tbody><tr style="height: 25px;"><td><strong>Nombre completo</strong></td><td><strong>Cargo</strong></td><td><strong>Instituci&oacute;n</strong></td><td><strong>Expositor</strong></td></tr><tr style="height: 25px;"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td style="width: 8.5%; text-align: center;">[&nbsp; &nbsp; ]</td></tr><tr style="height: 25px;"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td style="width: 8.5%; text-align: center;">[&nbsp; &nbsp; ]</td></tr><tr style="height: 25px;"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td style="width: 8.5%; text-align: center;">[&nbsp; &nbsp; ]</td></tr><tr style="height: 25px;"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td style="width: 8.5%; text-align: center;">[&nbsp; &nbsp; ]</td></tr></tbody></table><p><strong>Acuerdos:</strong></p><table style="width: 100%; border-collapse: collapse;" border="1"><tbody><tr><td><ol><li>&nbsp;</li></ol></td></tr></tbody></table><p>&nbsp;</p>';
                tinyMCE.activeEditor.setContent(contenido);
            }
            /* Acta de recepción */
            if ("11" === this.value) {
                var contenido = '<h1 style="text-align: center; text-decoration: underline;">ACTA DE RECEPCIÓN</h1> <p><strong>Datos de ubicación</strong></p> <table style="width: 100%; border-collapse: collapse;" border="1" cellpadding="2"> <tbody> <tr> <td style="width: 30%; height: 30px;">Establecimiento</td> <td></td> </tr> <tr> <td style="width: 30%; height: 30px;">Dirección</td> <td></td> </tr> <tr> <td style="width: 30%; height: 30px;">Unidad Organizacional</td> <td></td> </tr> <tr> <td style="width: 30%; height: 30px;">Ubicación (oficina)</td> <td></td> </tr> </tbody> </table> <p><strong>Características de la especie</strong></p> <table style="width: 100%; border-collapse: collapse;" border="1" cellpadding="2"> <tbody> <tr> <td style="width: 30%; height: 30px;">Inventario SSI</td> <td></td> </tr> <tr> <td style="width: 30%; height: 30px;">Tipo de equipo</td> <td></td> </tr> <tr> <td style="width: 30%; height: 30px;">Marca</td> <td></td> </tr> <tr> <td style="width: 30%; height: 30px;">Modelo</td> <td></td> </tr> <tr> <td style="width: 30%; height: 30px;">Número de serie</td> <td></td> </tr> </tbody> </table> <p><strong>Responsable</strong></p> <table style="width: 100%; border-collapse: collapse;" border="1" cellpadding="2"> <tbody> <tr> <td style="width: 30%; height: 30px;">Nombre completo</td> <td></td> </tr> <tr> <td style="width: 30%; height: 30px;">Función / cargo</td> <td></td> </tr>  </tbody> </table> <table style="height: 36px; width: 100%; border-collapse: collapse; margin-top: 60px" border="0"><tbody><tr><td style="width: 50%; height: 18px; text-align: center;">__________________________</td><td style="width:50%; height: 18px; text-align: center;">__________________________</td></tr><tr><td style="width: 50%; height: 18px; text-align: center;">{{ Auth::user()->tinnyName }}</td><td style="width: 50%; height: 18px; text-align: center;">SSI</td></tr><tr><td style="width: 50%; height: 18px; text-align: center;"><strong>Quien entrega</strong></td><td style="width: 50%; height: 18px; text-align: center;"><strong>Quien recepciona</strong></td></tr><tr><td></td><td style="width: 50%; height: 38px; text-align: center;"><br>_____/_____/_____________</td></tr></tbody></table>';
                tinyMCE.activeEditor.setContent(contenido);
            }
