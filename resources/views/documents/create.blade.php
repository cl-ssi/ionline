...
<script type="text/javascript">
    ...
    $('#formType').change(
        function() {
            ...
            /* Declaracion Jurada RIS-PACS */
            if ("24" === this.value) {
                $("#forFrom").removeAttr("required");
                $("#forFor").removeAttr("required");
                $("#collapse").hide();
                var contenido = '<h4 style="text-align: center;">DECLARACI&Oacute;N JURADA SIMPLE</h4><h4 style="text-align: center;">CUMPLIMIENTO PROTOCOLO INTERCAMBIO Y SEGURIDAD DE DATOS INFORM&Aacute;TICOS ASOCIADOS A LA ATENCI&Oacute;N DE SALUD</h4><h4 style="text-align: center;">IMAGENOLOG&Iacute;A MEDICA Y DENTOMAXILOFACIAL</h4><p>&nbsp;</p><p style="text-align: justify; line-height: 1.5;"><span style="font-size: 12pt;">En ________ a ___ d&iacute;as del mes de ______ de 20__, comparece ______________________________, de nacionalidad___________, profesi&oacute;n __________________, cargo ______________, RUT _______, con domicilio en _______________________, quien bajo juramento expone lo siguiente:</span></p><p style="text-align: justify; line-height: 1.5;"><span style="font-size: 12pt;">Declaro bajo juramento conocer los lineamientos y directrices contenidos en el &ldquo;Protocolo de Intercambio y Seguridad de Datos Inform&aacute;ticos Asociados a la Atenci&oacute;n de Salud para Imagenolog&iacute;a M&eacute;dica y Dentomaxilofacial&rdquo;, publicado por el Departamento de Integraci&oacute;n Digital - Servicio de Salud de Tarapac&aacute;; y, las materias y sanciones establecidas frente a una eventual vulneraci&oacute;n de ellas. Declaro adem&aacute;s haber recibido inducci&oacute;n y capacitaci&oacute;n para un adecuado uso del visualizador cl&iacute;nico para acceder a estudios de imagenolog&iacute;a m&eacute;dica y Dentomaxilofacial.</span></p><p style="text-align: justify; line-height: 1.5;"><span style="font-size: 12pt;">A mayor abundamiento, me obligo a no capturar ni difundir im&aacute;genes o informaci&oacute;n cl&iacute;nica contenida en las plataformas, sin expresa autorizaci&oacute;n de los administradores de sistemas RIS-PACS; a no compartir credenciales de acceso; y a no tener conductas que puedan ser consideradas o constitutivas de delitos asociados a la vulneraci&oacute;n de derechos de pacientes en lo relacionado con la gesti&oacute;n de informaci&oacute;n sensible y datos personales.</span></p>';
                tinyMCE.activeEditor.setContent(contenido);
            }
        }
    );
