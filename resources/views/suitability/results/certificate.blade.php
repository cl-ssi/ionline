...
<p class="justify" style="font-size:18px; line-height:150%;">
    ...
    evaluaciones y entrevista psicológica, en su calidad de postulante al cargo de Asistente de la Educación en el Establecimiento <strong>{{ $result->psirequest->school->name ?? ''  }} (RBD:{{ $result->psirequest->school->rbd ?? ''  }})</strong>, según lo dispone el Parrafo 1 del Artículo 4 de la ley
    21.109
</p>
<br>
<br>
...
<p class="justify" style="font-size:18px; line-height:150%;">
    ...
    @endif
    para desempeñarse como Asistente de la Educación en el citado establecimiento.
</p>
