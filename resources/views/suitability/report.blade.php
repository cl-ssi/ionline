...
@section('content')
    ...
    @if (!empty($dataArray))
        <a class="btn btn-outline-success btn-sm mb-3" id="downloadLink" onclick="exportF(this)">Descargar en excel
            resultados</a>
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-responsive text-center align-middle"
                id="tabla_estado_residencias">
                <thead>
                    <th nowrap>N°</th>
...
@section('custom_js')
    ...
    <script type="text/javascript">
        ...
        function exportF(elem) {
            ...
            elem.setAttribute("download", "reporte_idoneidad_consolidado_" + day + "_" + month + "_" + year + "_" + hour +
