    ...
    $(function () {
        $(document).ready(function(){
            $('#cierreSesion').click(function (){
                $.ajax({url: 'https://accounts.claveunica.gob.cl/api/v1/accounts/app/logout', headers: {'sec-fetch-site':'cross-site', 'SameSite':'None', 'upgrade-insecure-requests': 1, 'sec-fetch-mode': 'navigate'}}).always(function() {
