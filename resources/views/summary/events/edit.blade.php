    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="number" 
                ...
                id="num-repeat-input" 
                autocomplete="off"
                value="{{ $eventType->num_repeat ?? '' }}" 
                {{ $eventType->repeat ? '' : 'disabled' }}>
        </div>
    ...
    <fieldset class="form-group row">
        ...
        <div class="col-sm-10">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="require_user" id="for-require_user" value="1" {{ $eventType->require_user ? 'checked' : '' }}>
                <label class="form-check-label" for="for-require_user">
                    Requiere asignar un usuario
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="require_file" id="for-require_file" value="1" {{ $eventType->require_file ? 'checked' : '' }}>
                <label class="form-check-label" for="for-require_file">
                    Requiere adjuntar uno o más archivos
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="start" id="for-start" value="1" {{ $eventType->start ? 'checked' : '' }}>
                <label class="form-check-label" for="for-start">
                    Es el primer evento de un sumario
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="end" id="for-end" value="1" {{ $eventType->end ? 'checked' : '' }}>
                <label class="form-check-label" for="for-end">
                    Es el último evento de un sumario
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="investigator" id="for-investigator" value="1" {{ $eventType->investigator ? 'checked' : '' }}>
                <label class="form-check-label" for="for-investigator">
                    Este evento asigna al fiscal del sumario
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="actuary" id="for-actuary" value="1" {{ $eventType->actuary ? 'checked' : '' }}>
                <label class="form-check-label" for="for-actuary">
                    Este evento asigna al actuario del sumario
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="sub_event" id="for-sub_event" value="1" {{ $eventType->sub_event ? 'checked' : '' }}>
