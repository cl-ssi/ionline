...
<table id="tblData" class="table table-striped  table-sm table-bordered table-condensed fixed_headers table-hover  ">
    <thead>
        <tr style="font-size:75%;">
            <th class="text-center align-middle" colspan="{{$isTracer == 'SI' ? 4 : 3}}">REPORTE ACTIVIDADES DIRECTAS CONSOLIDADO {{$year}}</th>
        </tr>
    ...
    <tfoot>
        <tr style="font-size:60%;">
            <td class="text-center" colspan="{{$isTracer == 'SI' ? 2 : 1}}">TOTALES</td>
