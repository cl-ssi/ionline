<div class="collapse" id="collapseExample">
    <form method="POST" class="form-horizontal" enctype="multipart/form-data"
        action="{{ route('requirements.events.store') }}">
    @csrf
    @method('POST')
        ...
        <fieldset class="form-group col-4" id="div_destinatario">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <button type="button" class="btn btn-outline-primary add_destinatario"
                        data-toggle="tooltip" data-placement="top" id="add_destinatario"
                        title="Utilizar para agregar más de un destinatario">
                        <i class="fas fa-user-plus"></i>
                    </button>
                    <button type="button" class="btn btn-outline-primary add_destinatario_cc"
                        data-toggle="tooltip" data-placement="top" id="add_destinatario_cc"
