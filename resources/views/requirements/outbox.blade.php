...
@section('content')
    ...
    @if ($created_requirements->isNotEmpty())
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            <strong>¡Es importante que cierres tus requerimientos!</strong> Requerimientos abiertos producen demoras en tus
            tiempos productivos.
    ...
    <table class="table table-sm table-bordered table-responsive-xl">
        ...
        <tbody>
            ...
            <td class="small text-center">{{ $created->created_at->diffForHumans() }}</td>
                        ...
                        @if ($created->status == 'creado')
                            <form method="POST" action="{{ route('requirements.destroy', $created) }}" class="d-inline">
                                ...
                                <button type="submit" class="btn btn-sm btn-link"
                                    onclick="return confirm('¿Desea eliminar este requerimiento?')"><span style="color: red;"><i
                                            class="fas fa-trash-alt"></i><span></button></button>
                            </form>
                        @endif
                    @endcan
                </div>
    ...
    <table class="table table-sm table-bordered table-responsive-xl">
        ...
        <tbody>
            ...
            <td class="small text-center">{{ $archived->created_at->diffForHumans() }}</td>
            <!-- <td class="small" nowrap>
        @if ($archived->limit_at != null)
    {{ Carbon\Carbon::parse($archived->limit_at)->format('Y-m-d') }}
    @endif
        </td> -->
