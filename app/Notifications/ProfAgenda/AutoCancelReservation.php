...
class AutoCancelReservation extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Haz cancelado la reserva que tenías el para ' . $this->openHour->start_date->format('Y-m-d') . ' a las ' . $this->openHour->start_date->format('H:s') . ' con el profesional ' . $this->openHour->profesional->shortName . '.')
