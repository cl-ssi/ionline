...
class IndustrialEquipmentChart extends ChartWidget
{
    protected static ?string $heading = 'Ejecución Anual - Equipos Industriales';

    protected function getData(): array
    {
        // Obtener la cantidad de equipos médicos
        $medicalEquipmentCount = Equipment::where('type', 'Industrial')->count();
