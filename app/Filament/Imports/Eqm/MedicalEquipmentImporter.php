...
class MedicalEquipmentImporter extends Importer
{
    ...
    public function resolveRecord(): ?Equipment
    {
        ...
        // Crear o recuperar relaciones necesarias
        ...
        // Crear o actualizar el registro de equipo médico
    ...
    {
        $body = 'Your medical equipment import has completed with ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
