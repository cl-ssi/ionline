...
class ServicerequestFiles extends Command
{
    ...
    public function handle()
    {
        ...
        foreach($srs as $key => $sr) {
          print_r($sr->user_id . " " . $sr->last_created_at . " \n");
          $serviceRequest = ServiceRequest::where('user_id',$sr->user_id)
          ...
          $user = $serviceRequest->employee;
          $user->organizational_unit_id = $serviceRequest->responsability_center_ou_id;
          $user->save();
