...
class SeeShiftControlForm extends Component
{
  ...
  public $shiftStatus = array(
	...
	public function setValues($id){
        ...
        $this->log .="setValues";
        // $this->reset;
    //    $this->dispatch("setValueToShiftForm",["actuallyYears"=>$this->actuallyYears,"actuallyMonth"=>$this->actuallyMonth,"usr"=>$this->usr->id,"days"=> $this->days]);

		// $this->dispatch('jsLiveWireTest');
