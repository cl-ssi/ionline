...
class ShiftDayHistoryOfChanges extends Model
{
	...
	/*change_type: 0:asignado 1:cambio estado, 2 cambio de tipo de jornada, 3 intercambio con otro usuario;4:Confirmado por el usuario 5: confirmado por el administrador, 6:rechazado por usuario?, 7 Dejar disponible,8 Dispomnible ya tomado, 9 solicitud de dia  */
