...
class ShiftUserDay extends Model
{
    ...
    { // estado de la confirmacion x parte del usuario administrador de la Unidad Organizacional, en este caso por requerimiento se confirmar automaticamente los dias de cada turno
