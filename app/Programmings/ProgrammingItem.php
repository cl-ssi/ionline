...
class ProgrammingItem extends Model
{
    ...
    protected $fillable = ['id','cycle', 'action_type', 'ministerial_program','activity_id','activity_name', 'def_target_population', 'source_population',
                           ...
                           'direct_work_hour', 'information_source', 'prap_financed','observation'];
}
